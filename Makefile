...
cell.o: src/Geometry/cell.cc includes/Geometry/cell.hpp \
		includes/Geometry/coordinate.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cell.o src/Geometry/cell.cc
...
pdbqtatom.o: src/FileSet/PdbqtFileSpace/pdbqtatom.cc includes/FileSet/PdbqtFileSpace/pdbqtatom.hpp \
		includes/Geometry/coordinate.hpp \
		includes/utils.hpp \
		includes/common.hpp \
		includes/Glycam/sugarname.hpp
...
pdbqtatomcard.o: src/FileSet/PdbqtFileSpace/pdbqtatomcard.cc includes/FileSet/PdbqtFileSpace/pdbqtatomcard.hpp \
		includes/FileSet/PdbqtFileSpace/pdbqtatom.hpp \
		includes/Geometry/coordinate.hpp \
		includes/utils.hpp \
		includes/common.hpp \
		includes/Glycam/sugarname.hpp
...
pdbqtbranchcard.o: src/FileSet/PdbqtFileSpace/pdbqtbranchcard.cc includes/FileSet/PdbqtFileSpace/pdbqtbranchcard.hpp \
		includes/FileSet/PdbqtFileSpace/pdbqtatom.hpp \
		includes/Geometry/coordinate.hpp \
		includes/utils.hpp \
		includes/common.hpp \
...
pdbqtfile.o: src/FileSet/PdbqtFileSpace/pdbqtfile.cc includes/utils.hpp \
		includes/common.hpp \
		includes/Geometry/coordinate.hpp \
		includes/Glycam/sugarname.hpp \
		includes/FileSet/PdbqtFileSpace/pdbqtmodelcard.hpp \
		includes/FileSet/PdbqtFileSpace/pdbqtfile.hpp \
...
pdbqtmodel.o: src/FileSet/PdbqtFileSpace/pdbqtmodel.cc includes/FileSet/PdbqtFileSpace/pdbqtmodelresidueset.hpp \
		includes/FileSet/PdbqtFileSpace/pdbqtmodel.hpp \
		includes/utils.hpp \
		includes/common.hpp \
		includes/Geometry/coordinate.hpp \
		includes/Glycam/sugarname.hpp
...
pdbqtmodelcard.o: src/FileSet/PdbqtFileSpace/pdbqtmodelcard.cc includes/FileSet/PdbqtFileSpace/pdbqtmodel.hpp \
		includes/FileSet/PdbqtFileSpace/pdbqtmodelcard.hpp \
		includes/utils.hpp \
		includes/common.hpp \
		includes/Geometry/coordinate.hpp \
...
pdbqtmodelresidueset.o: src/FileSet/PdbqtFileSpace/pdbqtmodelresidueset.cc includes/FileSet/PdbqtFileSpace/pdbqtmodelresidueset.hpp \
		includes/FileSet/PdbqtFileSpace/pdbqtbranchcard.hpp \
		includes/FileSet/PdbqtFileSpace/pdbqtrootcard.hpp \
		includes/utils.hpp \
		includes/common.hpp \
		includes/Geometry/coordinate.hpp \
		includes/Glycam/sugarname.hpp
...
pdbqtremarkcard.o: src/FileSet/PdbqtFileSpace/pdbqtremarkcard.cc includes/FileSet/PdbqtFileSpace/pdbqtremarkcard.hpp \
		includes/utils.hpp \
		includes/common.hpp \
		includes/Geometry/coordinate.hpp \
		includes/Glycam/sugarname.hpp
