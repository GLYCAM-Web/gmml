...
g++ -std=c++0x -I $GEMSHOME/gmml/ -L$GEMSHOME/gmml/bin/ -Wl,-rpath,$GEMSHOME/gmml/bin/ tests/002.create_Assembly_WritePDB.cpp -lgmml -pthread -o create_Assembly_WritePDB
