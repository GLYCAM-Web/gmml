...
mkdir 013.outputs/
./buildOligosaccharideLibrary tests/inputs/013.smallLibrary.txt _ 013.outputs ../dat/prep/GLYCAM_06j-1_GAGS.prep > 013.output_buildOligosaccharideLibrary.txt 2>&1
