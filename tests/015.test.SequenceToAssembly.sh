...
g++ -std=c++17 -I $GEMSHOME/gmml/ -I $GEMSHOME/gmml/includes/ -L$GEMSHOME/gmml/bin/ -Wl,-rpath,$GEMSHOME/gmml/bin/ tests/015.test.SequenceAssembly.cc -lgmml -o sequenceAssembly
