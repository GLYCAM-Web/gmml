...
g++ -std=c++17 -I "${GMML_ROOT_DIR}"/ -L"${GMML_ROOT_DIR}"/bin/ -Wl,-rpath,"${GMML_ROOT_DIR}"/bin/ ../internalPrograms/GlycamResidueCombinator/glycamResidueCombinator.cpp -lgmml -pthread -o 027.glycamResiduecombinator.exe
