...
int main ()
{	
    std::string s1 = "DTalp[2S,3Me]a1-6DManpa1-6[DAllpNAcb1-3][DNeu5Aca2-6DGalpb1-4DGlcp[3S]b1-2DAltpa1-4]DManpb1-4DGulpNAc[6Me]b1-4DGlcpNAcb1-OH";
...
//	Now test sequenceManipulator
	for (auto &sequence : sequences)
    {
        ...
        man.Print();
        std::cout << "\nEND\n\n\n" << std::endl;
    	// std::cout << "\nPrintLabelledSequence:" << std::endl;
