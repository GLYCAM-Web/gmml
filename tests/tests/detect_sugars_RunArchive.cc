...
// Initialize an Assembly from the PDB file, build by Distance using 4 CPU cores, and remove
// hydrogens until the bug (involving hydrogens forming multiple bonds.. I think) is fixed
