...
int main()
{
    ...
    std::string condensed_sequence = "DNeup5Aca2-3DManp[2S,6Me]a1-6DManpa1-6[DGlcpNAcb1-4][DNeup5Aca2-6DGalpb1-"
                                     "4DGlcpNAc[3S]b1-2DManpa1-3]DManpb1-4DGlcpNAc[6Me]b1-4DGlcpNAcb1-OH";
    // std::string condensed_sequence =
    // "DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-6DManpa1-OH";
    ...
    carbBuilder.GetCarbohydrate().Print();
    std::string fileOutputDirectory = "unspecified"; // If it's "unspecified" or you don't pass a directory string it
                                                     // will write to the current working directory.
    bool likelyShapesOnly =
        true; // You can just pass "true" to the function. Not sure I like this. Two functions probably more readable.
    ...
    {
        std::cout << "Name: " << linkageInfo.linkageName_ << ", LinkageIndex: " << linkageInfo.indexOrderedLabel_
                  << ", Res1: " << linkageInfo.firstResidueNumber_ << ", Res2: " << linkageInfo.secondResidueNumber_
                  << "\n";
        for (auto& dihedralInfo : linkageInfo.likelyRotamers_)
        {
            ...
            {
                std::cout << ", " << rotamer;
                // use when checking multiple rotamers, but only works for one linkage, and you must uncomment out the
                // //fileName += "_" + rotamerInfo.selectedRotamer in GenerateSpecific3DStructure
                //                CondensedSequence::SingleRotamerInfoVector rotamerInfoVector = {
                //                {linkageInfo.indexOrderedLabel_, linkageInfo.indexOrderedLabel_,
                //                dihedralInfo.dihedralName_, rotamer, ""} };
