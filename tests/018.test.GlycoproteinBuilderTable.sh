...
g++ -std=c++17 -I $GEMSHOME/gmml/ -L$GEMSHOME/gmml/bin/ -Wl,-rpath,$GEMSHOME/gmml/bin/ tests/018.test.createGlycosylationTables.cpp -lgmml -pthread -o gpBuilderTable
./gpBuilderTable tests/inputs/4mbz_NoWat_NoConect_NoAnisou.pdb > 018.output_GlycoproteinBuilderTable.txt 2>&1
