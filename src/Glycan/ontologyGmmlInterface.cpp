...
void Ontology::PrintOntology(std::stringstream& ont_stream, const pdb::PdbFile& pdbFile)
{
    ...
    {
        std::string file =
            gmml::Split(pdbFile.GetInputFilePath().substr(pdbFile.GetInputFilePath().find_last_of('/') + 1), ".").at(0);
