...
ParameterFileAtom::ParameterFileAtom()
    : type_(""), mass_(gmml::dNotSet), polarizability_(gmml::dNotSet), dscr_(""), radius_(gmml::dNotSet),
      well_depth_(gmml::dNotSet), mod4_dscr_("")
{}

ParameterFileAtom::ParameterFileAtom(const std::string& type, double mass, double polarizability,
                                     const std::string& dscr)
    : type_(type), mass_(mass), polarizability_(polarizability), dscr_(dscr), radius_(gmml::dNotSet),
      well_depth_(gmml::dNotSet), is_hydrophilic_(false)
{}
...
ParameterFileAtom::ParameterFileAtom(const std::string& type, double mass, double polarizability, double radius,
    ...
    : type_(type), mass_(mass), polarizability_(polarizability), dscr_(dscr), radius_(radius), well_depth_(well_depth),
      mod4_dscr_(mod4_dscr)
{}

ParameterFileAtom::ParameterFileAtom(const std::string& type, double mass, double polarizability, double radius,
                                     double well_depth, const std::vector<std::string>& equivalent_list,
                                     const std::string& dscr, const std::string& mod4_dscr, bool is_hydrophilic)
    : type_(type), mass_(mass), polarizability_(polarizability), dscr_(dscr), radius_(radius), well_depth_(well_depth),
      mod4_dscr_(mod4_dscr), is_hydrophilic_(is_hydrophilic), equivalent_list_(equivalent_list)
{}
...
void ParameterFileAtom::Print(std::ostream& out)
{
    ...
    out << std::setw(60) << dscr_ << std::setw(60) << mod4_dscr_ << std::endl;
