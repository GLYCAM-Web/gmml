...
//                       Constructor                    //
//////////////////////////////////////////////////////////
ParameterFileAngle::ParameterFileAngle() : types_(), force_constant_(gmml::dNotSet), angle_(gmml::dNotSet), dscr_("")
{}

ParameterFileAngle::ParameterFileAngle(const std::vector<std::string>& types, double force_constant, double angle,
