							  ...
							  CondensedSequenceResidueTree& rearranged_tree_by_labeling, CondensedSequenceGlycam06ResidueTree& rearranged_06_tree_by_labeling)
{
    ...
    CondensedSequenceSpace::CondensedSequenceGlycam06Residue* corresponding_06_residue = this->condensed_sequence_glycam06_residue_tree_[current_residue_index];
								 ...
								 CondensedSequenceResidueTree& rearranged_tree_by_reordering, CondensedSequenceGlycam06ResidueTree& rearranged_06_tree_by_reordering)
{
    ...
    CondensedSequenceSpace::CondensedSequenceGlycam06Residue* corresponding_06_residue = this->condensed_sequence_glycam06_residue_tree_[current_index];
