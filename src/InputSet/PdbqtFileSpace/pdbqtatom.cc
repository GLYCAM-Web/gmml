...
PdbqtAtom::PdbqtAtom(int atom_serial_number, std::string atom_name, char atom_alternate_location,
                     std::string residue_name, char chain_id, int residue_sequence_number, char insertion_code,
                     GeometryTopology::Coordinate coordinate, double occupancy, double temperature_factor,
    ...
    : atom_serial_number_(atom_serial_number), atom_name_(atom_name), atom_alternate_location_(atom_alternate_location),
      ...
      atom_orthogonal_coordinate_(coordinate), atom_occupancy_(occupancy), atom_temperature_factor_(temperature_factor),
      atom_charge_(charge), atom_type_(atom_type), type_(type)
{}
...
{
    out << "Record Name: " << type_ << ", Atom Serial Number: ";
    ...
    out << ", Atom Charge: " << atom_charge_ << ", Atom Type: " << atom_type_ << std::endl;
}
