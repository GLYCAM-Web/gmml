...
TopologyDihedralType::TopologyDihedralType(int index, double force_constant, double periodicity, double phase,
                                           double scee, double scnb)
    : index_(index), periodicity_(periodicity), phase_(phase), scee_(scee), scnb_(scnb), force_constant_(force_constant)
{}
...
{
    out << "Dihedral index: " << index_ << ", Periodicity: " << periodicity_ << ", Phase: " << phase_
        << ", SCEE: " << scee_ << ", SCNB: " << scnb_ << ", Force constant: " << force_constant_;
}
