...
{
    out << "Dihedral: " << residue_names_.at(0) << ":" << dihedrals_.at(0) << "-" << residue_names_.at(1) << ":"
        << dihedrals_.at(1) << "-" << residue_names_.at(3) << ":" << dihedrals_.at(2) << "-" << residue_names_.at(3)
        << ":" << dihedrals_.at(3) << std::endl;
    out << "\t ";
