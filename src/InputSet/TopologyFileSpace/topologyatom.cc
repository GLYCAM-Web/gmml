...
TopologyAtom::TopologyAtom(int atom_index, std::string atom_name, std::string type, double atom_charge,
                           int atomic_number, double atom_mass, ExcludedAtomNames excluded_atoms,
                           int number_of_excluded_atoms, double radii, double screen,
                           std::string tree_chain_classification, std::string residue_name)
    : atom_name_(atom_name), atom_charge_(atom_charge), atomic_number_(atomic_number), atom_mass_(atom_mass),
      radii_(radii), screen_(screen), tree_chain_classification_(tree_chain_classification),
      number_of_excluded_atoms_(number_of_excluded_atoms), type_(type), index_(atom_index), residue_name_(residue_name)
{
