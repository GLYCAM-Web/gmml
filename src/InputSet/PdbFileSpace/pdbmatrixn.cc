...
GeometryTopology::Coordinate PdbMatrixN::GetTransformationVector(){
...
void PdbMatrixN::SetTransformationVector(GeometryTopology::Coordinate transfomration_vector){
