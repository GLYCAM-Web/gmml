...
//                       CONSTRUCTOR                    //
//////////////////////////////////////////////////////////
PdbHelixCard::PdbHelixCard()
    : helix_id_(""), helix_serial_number_(gmml::dNotSet), helix_class_(POLYPROLINE), comment_(""),
...
PdbHelixCard::PdbHelixCard(const std::string& helix_id, int helix_serial_number, HelixResidueVector helix_residues,
    ...
    : helix_id_(helix_id), helix_serial_number_(helix_serial_number), helix_class_(helix_class), comment_(comment),
...
{
    out << "Helix ID: " << helix_id_ << ", Helix Serial Number: ";
    ...
    out << std::endl << "=============== Helix Residues ==============" << std::endl;
    ...
    out << ", Comments: " << comment_ << "Helix Length: ";
