...
//                       CONSTRUCTOR                    //
//////////////////////////////////////////////////////////
PdbLinkCardResidue::PdbLinkCardResidue()
    : atom_name_(""), alternate_location_indicator_(' '), residue_name_(""), residue_chain_id_(' '),
      residue_sequence_number_(gmml::iNotSet), residue_insertion_code_(' '), symmetry_operator_(gmml::iNotSet)
{}

PdbLinkCardResidue::PdbLinkCardResidue(const std::string& atom_name, char alternate_location_indicator,
                                       const std::string& residue_name, char residue_chain_id,
    ...
    : atom_name_(atom_name), alternate_location_indicator_(alternate_location_indicator), residue_name_(residue_name),
      ...
      residue_insertion_code_(residue_insertion_code), symmetry_operator_(symmetry_operator)
{}
...
{
    out << "Atom Name: " << atom_name_ << ", Alterante Location Identifier: " << alternate_location_indicator_
        << ", Residue Name: " << residue_name_ << ", Residue Chain Identifier: " << residue_chain_id_
    ...
    out << ", Residue Insertion Code: " << residue_insertion_code_ << ", Symmetry Operator: ";
