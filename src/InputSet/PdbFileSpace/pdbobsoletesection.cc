...
//                       CONSTRUCTOR                    //
//////////////////////////////////////////////////////////
PdbObsoleteSection::PdbObsoleteSection()
    : record_name_("OBSLTE"), continuation_(""), replacement_date_(""), identifier_codes_()
{}
...
{
    out << "Record Name: " << record_name_ << std::endl << "=========== Obsolete =============" << std::endl;
    for (PdbObsoleteSection::ObsoleteCardVector::iterator it = obsolete_cards_.begin(); it != obsolete_cards_.end();
         it++)
    {
        out << "Obsolete Card: ";
        (*it)->Print(out);
