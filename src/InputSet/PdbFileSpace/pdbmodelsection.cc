...
PdbModelSection::PdbModelSection(std::stringstream& stream_block)
{
    ...
    while (!gmml::Trim(temp).empty())
    {
        if (line.find("MODEL") != std::string::npos)
        {
            ...
            while (line.find("MODEL") != std::string::npos || line.find("ATOM") != std::string::npos ||
                   line.find("ANISOU") != std::string::npos || line.find("TER") != std::string::npos ||
                   line.find("HETATM") != std::string::npos || line.find("ENDMDL") != std::string::npos)
            {
...
{
    out << "Record Name: " << record_name_ << std::endl << "================= Models =================" << std::endl;
