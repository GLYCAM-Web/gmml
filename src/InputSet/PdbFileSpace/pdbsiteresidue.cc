...
PdbSiteResidue::PdbSiteResidue(const std::string& residue_name, char residue_chain_id, int residue_sequence_number,
...
{
    out << "Residue Name: " << residue_name_ << ", Residue Chain ID: " << residue_chain_id_
    ...
    out << ", Residue Insertion Code: " << residue_insertion_code_ << std::endl << std::endl;
}
