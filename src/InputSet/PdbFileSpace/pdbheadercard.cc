...
//                       CONSTRUCTOR                    //
//////////////////////////////////////////////////////////
PdbHeaderCard::PdbHeaderCard()
    : record_name_("HEADER"), classification_(" "), deposition_date_(" "), identifier_code_(" ")
{}

PdbHeaderCard::PdbHeaderCard(const std::string& record_name, const std::string& classification,
...
void PdbHeaderCard::Print(std::ostream& out)
{
    out << "Record Name: " << record_name_ << ", Classification: " << classification_
        << ", Deposition Date: " << deposition_date_ << ", Identifier Code: " << identifier_code_ << std::endl
        << std::endl;
}
