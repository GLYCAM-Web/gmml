...
PdbConnectSection::PdbConnectSection(std::stringstream& stream_block)
{
    ...
    while (!gmml::Trim(temp).empty())
    {
        ...
        {
            for (std::vector<int>::iterator it = bonded_atom_serial_numbers.begin();
                 it != bonded_atom_serial_numbers.end(); it++)
            {
...
void PdbConnectSection::SetBondedAtomsSerialNumbers(BondedAtomsSerialNumbersMap bonded_atom_serial_numbers)
{
    ...
    for (BondedAtomsSerialNumbersMap::iterator it = bonded_atom_serial_numbers.begin();
         it != bonded_atom_serial_numbers.end(); it++)
    {
...
void PdbConnectSection::Print(std::ostream& out)
{
    ...
    for (PdbConnectSection::BondedAtomsSerialNumbersMap::iterator it = bonded_atom_serial_numbers_.begin();
         it != bonded_atom_serial_numbers_.end(); it++)
    {
