...
PdbFormulaCard::PdbFormulaCard(const std::string& heterogen_identifier, int component_number,
                               const std::string& chemical_formula)
    : heterogen_identifier_(heterogen_identifier), component_number_(component_number),
...
{
    out << "Heterogen ID: " << heterogen_identifier_ << ", Component Number: ";
