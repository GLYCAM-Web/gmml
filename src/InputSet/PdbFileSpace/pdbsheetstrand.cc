    ...
    : sense_(sense), current_atom_(current_atom), previous_atom_(previous_atom)
{
    ...
    for (PdbSheetStrand::SheetStrandResidueVector::const_iterator it = strand_residues.begin();
         it != strand_residues.end(); it++)
    {
...
void PdbSheetStrand::Print(std::ostream& out)
{
    ...
    for (PdbSheetStrand::SheetStrandResidueVector::iterator it = strand_residues_.begin(); it != strand_residues_.end();
         it++)
    {
        (*it)->Print(out);
        out << std::endl;
    ...
    out << ", Current Atom: " << current_atom_ << ", Previous Atom: " << previous_atom_ << std::endl << std::endl;
}
