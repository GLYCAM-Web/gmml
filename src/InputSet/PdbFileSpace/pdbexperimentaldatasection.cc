...
//                       CONSTRUCTOR                    //
//////////////////////////////////////////////////////////
PdbExperimentalDataSection::PdbExperimentalDataSection() : record_name_("KEYWDS"), experimental_data_(""){}
...
{
    out << "Record Name: " << record_name_ << ", ExperimentalData: " << experimental_data_ << endl << endl;
}
