...
PdbResidue::PdbResidue(std::string residue_name, char chain_id, int sequence_number, char insertion_code,
                       char residue_alternate_location)
    : residue_chain_id_(chain_id), residue_name_(residue_name), residue_sequence_number_(sequence_number),
      residue_insertion_code_(insertion_code), residue_alternate_location_(residue_alternate_location)
{}
