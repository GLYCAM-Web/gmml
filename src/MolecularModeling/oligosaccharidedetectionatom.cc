...
//                       CONSTRUCTOR                    //
//////////////////////////////////////////////////////////
MolecularModeling::OligoSaccharideDetectionAtom::OligoSaccharideDetectionAtom()
    : IsCycle_(false), IsSideChain_(false), IsAnomericCarbon_(false), naming_("")
{}
...
OligoSaccharideDetectionAtom::OligosaccharidePropertyTags
MolecularModeling::OligoSaccharideDetectionAtom::GetAllOligosaccharidePropertyTags()
{
...
void MolecularModeling::OligoSaccharideDetectionAtom::AddOligosaccharidePropertyTag(
    std::pair<std::string, std::string> role_tag_pair)
{
    oligosaccharide_properties_.insert(role_tag_pair);
}

void MolecularModeling::OligoSaccharideDetectionAtom::RemoveOligosaccharidePropertyTag(
    std::pair<std::string, std::string> role_tag_pair)
{
    std::string role = role_tag_pair.first;
    std::string tag  = role_tag_pair.second;
    for (OligosaccharidePropertyTags::iterator it = oligosaccharide_properties_.begin();
         it != oligosaccharide_properties_.end(); it++)
    {
