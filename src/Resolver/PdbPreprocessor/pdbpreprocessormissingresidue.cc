...
PdbPreprocessorMissingResidue::PdbPreprocessorMissingResidue(char chain_id, int start_index, int end_index,
                                                             int index_before_gap, int index_after_gap,
...
{
    out << "Chain: " << starting_residue_sequence_number_ << "-" << ending_residue_sequence_number_ << "("
        << residue_chain_id_ << ")"
        ...
        << ", Selected n termination: " << GetStringFormatOfSelectedNTermination() << std::endl;
}
