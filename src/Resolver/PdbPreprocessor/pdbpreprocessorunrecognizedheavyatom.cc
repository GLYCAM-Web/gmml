...
PdbPreprocessorUnrecognizedHeavyAtom::PdbPreprocessorUnrecognizedHeavyAtom(
    ...
    : residue_chain_id_(residue_chain_id), atom_serial_number_(atom_serial_number), atom_name_(atom_name),
      residue_name_(residue_name), residue_sequence_number_(residue_sequence_number),
...
{
    out << "Atom name: " << atom_name_ << ", Serial number: " << atom_serial_number_
        << ", Chain id: " << residue_chain_id_ << ", Residue name: " << residue_name_
