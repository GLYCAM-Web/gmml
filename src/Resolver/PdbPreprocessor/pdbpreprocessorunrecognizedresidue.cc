...
PdbPreprocessorUnrecognizedResidue::PdbPreprocessorUnrecognizedResidue(std::string residue_name, char chain_id,
...
void PdbPreprocessorUnrecognizedResidue::Print(std::ostream& out)
{
    out << "Residue name: " << residue_name_ << ", Chain id: " << residue_chain_id_
        ...
        << ", Alternate location: " << residue_alternate_location_ << ", In the middle of chain: " << middle_of_chain_
        << std::endl;
}
