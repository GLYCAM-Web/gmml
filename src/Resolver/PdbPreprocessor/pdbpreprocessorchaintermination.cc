...
PdbPreprocessorChainTermination::PdbPreprocessorChainTermination(char chain_id, int starting_sequence_number,
                                                                 int ending_sequence_number,
                                                                 char starting_residue_insertion_code,
...
std::string
PdbPreprocessorChainTermination::GetStringFormatOfNTermination(gmml::PossibleNChainTermination n_termination)
{
...
std::string
PdbPreprocessorChainTermination::GetStringFormatOfCTermination(gmml::PossibleCChainTermination c_termination)
{
...
std::vector<std::string> PdbPreprocessorChainTermination::GetAllPossibleNChainTerminationAsString()
{
    ...
    for (int possible_n_chian_termination = gmml::COCH3; possible_n_chian_termination != gmml::NH3;
         possible_n_chian_termination++)
    {
        all_possible_n_chian_termination_as_string.push_back(
            GetStringFormatOfNTermination((gmml::PossibleNChainTermination)possible_n_chian_termination));
    }
...
std::vector<std::string> PdbPreprocessorChainTermination::GetAllPossibleCChainTerminationAsString()
{
    ...
    for (int possible_c_chian_termination = gmml::NH2; possible_c_chian_termination != gmml::CO2;
         possible_c_chian_termination++)
    {
        all_possible_c_chian_termination_as_string.push_back(
            GetStringFormatOfCTermination((gmml::PossibleCChainTermination)possible_c_chian_termination));
    }
...
{
    out << "Chain id " << residue_chain_id_ << ", Start sequence number: " << starting_residue_sequence_number_
        ...
        << ", Selected c termination: " << GetStringFormatOfSelectedCTermination() << std::endl;
}
