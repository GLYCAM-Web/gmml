...
PdbPreprocessorReplacedHydrogen::PdbPreprocessorReplacedHydrogen(char residue_chain_id, int atom_serial_number,
                                                                 std::string atom_name, std::string residue_name,
...
void PdbPreprocessorReplacedHydrogen::Print(std::ostream& out)
{
    out << "Atom name: " << atom_name_ << ", Serial number: " << atom_serial_number_
        << ", Residue name: " << residue_name_ << ", Sequence number: " << residue_sequence_number_
        << ", chain id: " << residue_chain_id_ << ", insertion code: " << residue_insertion_code_
