...
PdbPreprocessorDisulfideBond::PdbPreprocessorDisulfideBond(
    char residue_chain_id_1, char residue_chain_id_2, int residue_sequence_number_1, int residue_sequence_number_2,
    double distance, bool is_bonded, char residue_insertion_code_1, char residue_insertion_code_2,
    char residue_alternate_location_1, char residue_alternate_location_2, int sulfur_atom_serial_number_1,
    int sulfur_atom_serial_number_2)
    : residue_chain_id_1_(residue_chain_id_1), residue_chain_id_2_(residue_chain_id_2),
      residue_sequence_number_1_(residue_sequence_number_1), residue_sequence_number_2_(residue_sequence_number_2),
      distance_(distance), is_bonded_(is_bonded), residue_insertion_code_1_(residue_insertion_code_1),
...
{
    out << "[Chain id: " << residue_chain_id_1_ << ", Sequence number: " << residue_sequence_number_1_
        << ", Insertion code: " << residue_insertion_code_1_
        << ", Alternate location: " << residue_alternate_location_1_ << "]--[Chain id: " << residue_chain_id_2_
        << ", Sequence number: " << residue_sequence_number_2_ << ", Insertion code: " << residue_insertion_code_2_
        << ", Alternate location: " << residue_alternate_location_2_ << "] => Distance: " << distance_ << std::endl;
}
