...
PdbPreprocessorDisulfideBond::PdbPreprocessorDisulfideBond(char residue_chain_id_1, char residue_chain_id_2, int residue_sequence_number_1, int residue_sequence_number_2, double distance,
                                                           bool is_bonded, char residue_insertion_code_1, char residue_insertion_code_2, char residue_alternate_location_1, char residue_alternate_location_2) :
    ...
    residue_insertion_code_2_(residue_insertion_code_2), residue_alternate_location_1_(residue_alternate_location_1), residue_alternate_location_2_(residue_alternate_location_2) {}
