...
static const std::vector<BondLengthByTypePair> bondLengthByTypePairTable = {
...
double GlycamMetadata::GetBondLengthForAtomTypes(std::string query1, std::string query2)
{
    for (const auto& entry : bondLengthByTypePairTable)
    ...
    return constants::defaultBondLength;
}
