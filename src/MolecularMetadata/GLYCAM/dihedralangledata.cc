...
{   // const AmberAtomTypeInfo Glycam06j1AtomTypes[] =
    ...
    { // Regex1  , Regex2   , Name   , Angle  , Upper  , Lower  , Weight, Entry Type    , Name , B , I , Res1 Condition , Res2 Conditions           , Atom names                                                               // Atom names this applies to
        ...
        { "C.*"  , "O8"     , "Omg8" ,-170.1  ,  20.0  ,  20.0  , 0.42  , "conformer"   , "A"  , 3 , 1 , {"none", "internal"}                , {"ulosonate"}    , "O8" , "C8" , "C7" , "C6"  },
        { "C.*"  , "O8"     , "Omg7" , -61.8  ,  20.0  ,  20.0  , 0.42  , "conformer"   , "A"  , 4 , 1 , {"none", "internal"}                , {"ulosonate"}    , "C8" , "C7" , "C6" , "O6"  },
        { "C.*"  , "O8"     , "Omg9" ,  65.8  ,  20.0  ,  20.0  , 0.42  , "conformer"   , "A"  , 5 , 1 , {"none", "internal"}                , {"ulosonate"}    , "O9" , "C9" , "C8" , "O8"  },
        ...
        { "C.*"  , "O8"     , "Omg8" ,-160.4  ,  20.0  ,  20.0  , 0.42  , "conformer"   , "A"  , 3 , 1 , {"none", "external"}                , {"ulosonate"}    , "O8" , "C8" , "C7" , "C6"  },
        { "C.*"  , "O8"     , "Omg7" , -59.6  ,  20.0  ,  20.0  , 0.42  , "conformer"   , "A"  , 4 , 1 , {"none", "external"}                , {"ulosonate"}    , "C8" , "C7" , "C6" , "O6"  },
        { "C.*"  , "O8"     , "Omg9" ,  73.4  ,  20.0  ,  20.0  , 0.42  , "conformer"   , "A"  , 5 , 1 , {"none", "external"}                , {"ulosonate"}    , "O9" , "C9" , "C8" , "O8"  },
