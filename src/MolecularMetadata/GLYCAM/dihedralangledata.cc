...
{ // const AmberAtomTypeInfo Glycam06j1AtomTypes[] =
  ...
  // Regex1  , Regex2   , Name   , Angle  , Upper  , Lower  , Weight, Entry Type    , Name , B , I , Res1
  // Condition , Res2 Conditions           , Atom names  // Atom names this applies to
        {   "C1",
         "O[1-9]",  "Phi",
         180.0,25.0,
         25.0,1.0,
         ...
         {"monosaccharide"},
         "C2",  "C1",
         "O.",  "C." }, // Phi should be C2-C1(ano)-Ox-Cx, or C1-C2(ano)-Ox-Cx
        {   "C2",
         "O[1-9]",  "Phi",
         -60.0,
         25.0,   25.0,
         1.0,  "permutation",
         "g",   1,
         1,       {"n-carbon=6", "ketose", "alpha"},
         {"monosaccharide"},
         "C1",  "C2",
         "O.",  "C." }, // Phi is defined by C1-C2(ano)-Ox-Cx for ketoses like Fru
        {   "C2",
         "O[1-9]",  "Phi",
         60.0, 25.0,
         25.0,   1.0,
 ...
 // Generic psi linkages, why is this labelled "ap"?
        {   "C.",
         ...
         {"monosaccharide"},
         "C.",  "O.",
         "C.",  "H." }, // Psi should be C(ano)-Ox-Cx-Hx, if Cx is ring, otherwise, C(ano)-Ox-Cx-C(x-1)
        {   "C.",
         "O[6-9]",  "Psi",
         180.0, 40.0,
         40.0,   1.0,
 ...
 // Omega angle in x-5 linkages.
        ...
        {  "C.*",
         ...
         "O5",  "C5",
         "C4",  "O4" },
 // 2-7 linkages copied from GlycamWeb Jan 2021. Branching in the linkage causes oddities with the bond number
  // and which atoms are chosen for the torsion.
        {   "C2",
         "O7",  "Phi",
         -60.0,
         20.0,   20.0,
 ...
 // External 2-8 linkages
        ...
        {   "C2",
         ...
         "O9",  "C9",
         "C8",  "O8" },
 // Sucrose from: Bock K, Lemieux RU. Carbohydrate Research, 100 (1982) 63-74. Now allowing ordering of sequence
  // either way, thus four entries instead of two.
        {   "C1",
         "O2",  "Phi",
         -135.0,
         5.0,    5.0,
 ...
 // Common sugar derivatives
  // Phosphate/sulfate
        ...
        {"[SP]1",
         ...
         "O6",  "C6",
         "C5",  "O5" },
 //        These two were removed to stop them showing up as options the carb builder, but for some applications
  //        like grafting you may want them enabled. No functionality for that context yet tho.
  //        { "[SP]1", "O6"     , "Omg"  ,  60.0  ,  20.0  ,  20.0  , 1.0   , "permutation" , "gt" , 3 , 2 ,
  //        {"derivative"}       , {"monosaccharide"}                  , "O6" , "C6" , "C5" , "O5"  },
  //        { "[SP]1", "O6"     , "Omg"  , 180.0  ,  20.0  ,  20.0  , 1.0   , "permutation" , "tg" , 3 , 3 ,
  //        {"derivative"}       , {"gauche-effect=galacto"} , "O6" , "C6" , "C5" , "O5"  },
  // Ac ACX
        {  "C1A",
         "O[1-9]",  "Phi",
         180.0, 20.0,
