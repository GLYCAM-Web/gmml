...
Sequence::Sequence(std::string condensedSequence)
{
    ...
    {
        gmml::log(__LINE__, __FILE__, gmml::ERR, "Sequence class constructor caught this exception message: " + exceptionMessage);
    ...
    {
        gmml::log(__LINE__, __FILE__, gmml::ERR, "Sequence class constructor caught a throw that was not anticipated. Death?");
        this->SetStatus("ERROR", "carbohydrateBuilder constructor caught a throw type that was not anticipated. Please report how you got to this to glycam@gmail.com.");
    }
}
