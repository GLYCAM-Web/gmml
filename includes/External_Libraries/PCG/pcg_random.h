...
#define PCG_DEFINE_CONSTANT(type, what, kind, constant) \
    ...
    template<typename itype> class specific_stream
    {
      ...
      protected:
        ...
        specific_stream(itype specific_seq) : inc_((specific_seq << 1) | itype(1U))
        {
            // Nothing (else) to do.
        }
    };
    ...
    class extended : public baseclass
    {
      ...
      public:
        ...
        template<typename CharT, typename Traits, bitcount_t table_pow2_, bitcount_t advance_pow2_, typename baseclass_,
                    ...
                    const extended<table_pow2, advance_pow2, baseclass, extvalclass, kdd>& rhs)
    {
        ...
        return base_lhs == base_rhs && !memcmp((void*)lhs.data_, (void*)rhs.data_, sizeof(lhs.data_));
    }
