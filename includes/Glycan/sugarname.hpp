...
namespace Glycan
{
  struct SugarName
  {
    ...
    std::string monosaccharide_stereochemistry_short_name_;     /*!< The condensed stereochemisty name of the monosaccharide >*/
    std::string isomer_;                                        /*!< The isomer(D/L) info of the monosaccharide >*/
    std::string name_;                                          /*!< The base name of the monosaccharide >*/
    std::string ring_type_;                                     /*!< The ring type of the monosaccharide which can be P/F which represents pyranose and furanose accordingly >*/
