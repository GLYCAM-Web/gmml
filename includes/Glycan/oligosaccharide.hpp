...
namespace Glycan
{
    ...
    class Oligosaccharide
    {
      public:
        ...
        std::vector<Oligosaccharide*>
            child_oligos_; /*!< The oligosacchrides that are attached to the current oligosaccharide >*/
        std::vector<std::string>
            child_oligos_linkages_; /*!< The linkages between the current oligosaccharide and oligosacchrides that are
                                       attached to it. i.e. C4_13_4GB_?_2_?_?_1-O4_23_4GB_?_2_?_?_1-C1_24_0MA_?_3_?_?_1
                                       >*/
        ...
        std::vector<std::string>
            sorted_monos; /*!< The monosaccharides sorted in the order they are printed in the sequence >*/
        std::string oligosaccharide_linkages_; /*!< The complete sequence of the linkages of the oligosacchride >*/
        std::string oligosaccharide_residue_linkages_; /*!< The complete sequence of the residue linkages of the
                                                          oligosacchride >*/
        ...
        bool chemically_modified_terminal_ = false;
        ...
        Oligosaccharide(std::vector<Glycan::Monosaccharide*> monos, gmml::ResidueNameMap dataset_residue_names,
        ...
        /*! \fn
         * A recursive function in order to generate the name sequence and the linkages between sacchrides of an
         * oligosacchride This functions starts from the root sacchride and generates the name sequence and linkages in
         * reverse order
         * @param oligosaccharide_name The name sequence of the oligosacchride that has been generated by the function
         * so far
         * @param oligosaccharide_linkages The linkages between sacchrides of the oligosacchride which has been
         * generated by the function so far
         ...
         * @param is_cycle The boolean variable which represnets whether the sacchrides involved in the oligosacchride
         * forms a cycle
         */
        void GenerateNameLinkage(std::string& oligosaccharide_name, std::string& oligosaccharide_linkages, int& i,
                                 int main_root_id, bool& is_cycle);
        ...
        void indexMono(Glycan::Monosaccharide* thisMono, int thisIndex,
                       std::vector<Glycan::Monosaccharide*>& branchedMonos);
        void indexBranches(std::vector<Glycan::Monosaccharide*> branchedMonos);
        std::vector<Glycan::Monosaccharide*> IUPACindexMono(Glycan::Monosaccharide* thisMono, int thisIndex,
                                                            std::vector<Glycan::Monosaccharide*>& branchedMonos);
        ...
        std::string CheckTerminals(MolecularModeling::Atom* target,
        ...
        std::string CheckOMETerminal(MolecularModeling::Atom* target,
                                     std::vector<MolecularModeling::Atom*>& terminal_atoms);
        std::string CheckROHTerminal(MolecularModeling::Atom* target,
                                     std::vector<MolecularModeling::Atom*>& terminal_atoms);
        std::string CheckTBTTerminal(MolecularModeling::Atom* target,
                                     std::vector<MolecularModeling::Atom*>& terminal_atoms);
