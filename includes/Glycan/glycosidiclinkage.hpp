  ...
  */
  public:
    ...
    */
    ...
    int phi_CHI_function_ = -1;/*!<The number of the CHI energy functuion used for the phi angle; Needed for properly selecting energy plots>*/
    int psi_CHI_function_ = -1;/*!<The number of the CHI energy functuion used for the psi angle; Needed for properly selecting energy plots>*/
    int omega_CHI_function_ = -1;/*!<The number of the CHI energy functuion used for the omega angle; Needed for properly selecting energy plots>*/
