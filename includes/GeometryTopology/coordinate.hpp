...
namespace GeometryTopology
{
    ...
    class Coordinate
    {
      public:
         ...
         */
        Coordinate* ConvertInternalCoordinate2CartesianCoordinate(CoordinateVector coordinate_list, double distance,
                                                                  double angle, double torsion);
        Coordinate* ConvertCartesianCoordinate2InternalCoordinate(Coordinate* coordinate,
