...
namespace GeometryTopology
{
    class Cell
    {
      public:
        ...
        Cell(GeometryTopology::Coordinate* min, GeometryTopology::Coordinate* max, double charge,
             double potential_energy);
        Cell(Grid* grid, GeometryTopology::Coordinate* min, GeometryTopology::Coordinate* max, double charge,
             double potential_energy);
