...
class Residue_linkage
{
  public:
    ...
    Residue_linkage(Residue* nonReducingResidue1, Residue* reducingResidue2, AtomVector alsoMovingAtoms,
    ...
    void SimpleWiggleCurrentRotamers(AtomVector& overlapAtomSet1, AtomVector& overlapAtomSet2,
  ...
  private:
    ...
    std::vector<Rotatable_dihedral> FindRotatableDihedralsConnectingResidues(Atom* from_this_connection_atom1,
