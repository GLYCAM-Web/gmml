...
namespace GeometryTopology
{
    ...
    class Grid
    {
      public:
        ...
        Grid(MolecularModeling::Assembly* assembly, Coordinate* min, Coordinate* max, double ion_radius,
             double ion_charge);
        Grid(MolecularModeling::Assembly* assembly, Coordinate* min, Coordinate* max, double cell_length,
