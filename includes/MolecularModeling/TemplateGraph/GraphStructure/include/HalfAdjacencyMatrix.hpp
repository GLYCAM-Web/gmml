...
namespace glygraph
{
    ...
    template<class T> class HalfAdjacencyMatrix
    {
      public:
        /************************************************
         ...
         ***********************************************/
        HalfAdjacencyMatrix();
        HalfAdjacencyMatrix(const std::vector<Node<T>*>& nodeList_t);
        // copy constructor
        ...
        void initializeWorkaround(const std::vector<Node<T>*>& nodeList_t);
    ...
    template<class T> HalfAdjacencyMatrix<T>::HalfAdjacencyMatrix(const std::vector<Node<T>*>& nodeList_t)
    {
    ...
    template<class T> void HalfAdjacencyMatrix<T>::initializeWorkaround(const std::vector<Node<T>*>& nodeList_t)
    {
        unsigned int numNodes = nodeList_t.size();
        this->bitList_m.assign(((numNodes * (numNodes - 1)) / 2), 0);
        this->numNodes_m    = numNodes;
    ...
    template<class T> void HalfAdjacencyMatrix<T>::disconnect(unsigned int aNodeIndex_t, unsigned int bNodeIndex_t)
    {
        if (!(this->bitList_m[index(aNodeIndex_t, bNodeIndex_t)]))
        {
    ...
    template<class T> bool HalfAdjacencyMatrix<T>::isConnected(unsigned int aNodeIndex_t, unsigned int bNodeIndex_t)
    {
