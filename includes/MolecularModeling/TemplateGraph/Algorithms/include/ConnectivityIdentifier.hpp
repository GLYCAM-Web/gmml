...
namespace id_connectivity
{
    ...
    template<class T> void bridgeDetect(glygraph::Graph<T>& graphToBridgeDetect_t)
    {
    ...
    template<class T> void leafDetect(glygraph::Graph<T>& graphToLeafDetect_t)
    {
    ...
    template<class T> void cycleDetect(glygraph::Graph<T>& graphToCycleDetect_t)
    {
    ...
    //
    //
    template<class T> void identifyConnectivity(glygraph::Graph<T>& graphToConnectivityDetect_t)
    {
