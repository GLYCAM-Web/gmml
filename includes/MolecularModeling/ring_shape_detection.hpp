...
namespace glylib
{
    ...
    double calculateTorsionAngle(GeometryTopology::Coordinate* coord1, GeometryTopology::Coordinate* coord2,
    ...
    bool does_conformation_match(int jloops, int* sortedplanes, int* atoms, int atoms_size, int* list,
...
// This doesn't belong here. Doesn't belong in Assembly (where I took it from), it belongs in Monosaccharide right?
// Except that's not a class.
namespace gmml
{
