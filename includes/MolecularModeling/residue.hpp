...
namespace MolecularModeling
{
    ...
    class Residue : public ResidueProperties, public Abstract::absResidue, public glygraph::Node<Residue>
    {
      public:
        ...
        // typedef PrepFileSpace::PrepFileResidue PrepFileResidue; // What was this doing? Ah ok, it was bandaging a
        // deeper issue.
        //////////////////////////////////////////////////////////
        //                       CONSTRUCTOR                    //
        //////////////////////////////////////////////////////////
         ...
         * 11/20/17 for residuenodes in assembly An accessor function in order to access to the node
        ...
        /*! \fn                                                                                          //Added by
         * ayush on 11/20/17 for residuenode in assembly A mutator function in order to set the node of the current
         * object Set the residuenode_ attribute of the current residue
        ...
        //                       FUNCTIONS                      //
        //////////////////////////////////////////////////////////
        std::string CreateID(std::string name = "default", std::string chain = "default",
        ...
        /// Check if all atoms in the residue have their atom type --> Element symbols come from parameter file (2nd
        /// priority)
        ...
        // GeometryTopology::Coordinate GetRingCenter(); disabled by OG. GetIsRing returns true for all atoms even when
        // IsRing wasn't set.
      ...
      private:
        ...
        std::string id_; /*!< An identifier for a residue that is generated based on the type of the given file from
        ...
        ResidueNode* residuenode_;
        /*!< A Pointer to a node of the graph structure that indicates this residue >*/ // Added by ayush on
                                                                                        // 11/20/17 for residuenode
                                                                                        // in assembly
