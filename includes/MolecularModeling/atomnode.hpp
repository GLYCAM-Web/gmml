...
namespace MolecularModeling
{
    ...
    class AtomNode
    {
      public:
        ...
        /*! \fn                                                  //Added by Ayush on 04/11/2018 for Direction based
         * bonded Atoms in Assembly. An accessor function in order to access whether a Atomnode is visited during Graph
         * Traversal, returns true if a Atomode is visited.
        ...
        /*! \fn                                                            //Added by Ayush on 04/11/2018 for Direction
         * based bonded Atoms in Assembly. A mutator function in order to set true if a Atomnode is visited during Graph
         * Traversal Set the isVisited_ attribute of the current Atomnode object
      ...
      private:
        ...
        bool isVisited_;
        /*!< A boolean value to check if the node is visted while traversing atomnodes in the graph >*/ // Added by
                                                                                                        // Ayush on
                                                                                                        // 04/11/2018
                                                                                                        // for
                                                                                                        // Direction
