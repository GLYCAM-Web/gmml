...
namespace MolecularModeling
{
    ...
    class ResidueNode
    {
      public:
        ...
        /*! \fn
         * An accessor function in order to access whether a residuenode is visited, returns true if a residuenode is
         * visited.
      ...
      private:
        ...
        ResidueNodeConnectingAtomVector residuenode_connecting_atoms_; /*!< List of all atoms connecting to atoms in
                                                                          another residuenode in the graph>*/
