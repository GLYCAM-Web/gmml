...
namespace CoordinateFileSpace
{
    ...
    class CoordinateFile
    {
      public:
         ...
         * @param title A string defines the title of the coordinate file which is extracted from the contents of the
         * file
         */
      ...
      private:
        ...
        int number_of_coordinates_; /*!< Number of coordinates containing in the file; set by the second line of a
                                       coordinate file */
        std::vector<GeometryTopology::Coordinate*>
            coordinates_; /*!< List of coordinates in a coordinate file; from the 3rd line of a coordinate file to
