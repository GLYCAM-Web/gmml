...
namespace CondensedSequenceSpace
{
    ...
    class CondensedSequenceResidue
    {
      public:
        ...
        int GetBondId(); // Added by Yao 08/03/2018. Bond Id is to label the index of the bond of a residue to its
                         // parent, starting from reducing end.Numbering starts from 0.
        /** @}*/
        //////////////////////////////////////////////////////////
        //                       MUTATOR                        //
        //////////////////////////////////////////////////////////
        ...
        void SetBondId(int bond_id); // Added by Yao 08/03/2018. Bond Id is to label the index of the bond of a residue
                                     // to its parent, starting from reducing end.Numbering starts from 0.
        /** @}*/
        //////////////////////////////////////////////////////////
        //                        FUNCTIONS                     //
        //////////////////////////////////////////////////////////
      ...
      private:
        ...
        int bond_id_; // Added by Yao 08/03/2018. Bond Id is to label the index of the bond of a residue to its parent,
                      // starting from reducing end.Numbering starts from 0.
    };
} // namespace CondensedSequenceSpace
