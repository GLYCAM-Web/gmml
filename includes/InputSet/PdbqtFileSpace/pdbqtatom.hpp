...
namespace PdbqtFileSpace
{
    class PdbqtAtom
    {
      public:
         ...
         * @param atom_type
         */
        PdbqtAtom(int atom_serial_number, std::string atom_name, char atom_alternate_location, std::string residue_name,
                  char chain_id, int residue_sequence_number, char insertion_code,
                  GeometryTopology::Coordinate coordinate, double occupancy, double temperature_factor, double charge,
                  std::string atom_type, std::string type);
