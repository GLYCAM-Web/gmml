...
namespace PdbFileSpace
{
    ...
    class PdbDisulfideBondSection
    {
      public:
        ...
        //////////////////////////////////////////////////////////
        /*! \typedef
         * A mapping between disulfide residue serial number and its belonging records in a disulfide residue bond card
         * in a pdb file
         */
        ...
        /*! \fn
         * A constructor that get a stream block of disulfide bond card and parse the whole block to fill the related
         * fields
      ...
      private:
        ...
        DisulfideResidueBondMap disulfide_residue_bonds_; /*!< Map of disulfide bonds in a disulfide bond card in a pdb
                                                             file by their serial numbers */
    };
} // namespace PdbFileSpace
