...
namespace PdbFileSpace
{
    class PdbSiteResidue
    {
      public:
         ...
         * @param residue_name Name of site residue card record that appears in the first column of each line of a pdb
         * file
         ...
         */
        PdbSiteResidue(const std::string& residue_name, char residue_chain_id, int residue_sequence_number,
      ...
      private:
        ...
        int residue_sequence_number_; /*!< Sequence number of a residue that appears in a site residue card of a pdb
                                         file >*/
        char residue_insertion_code_; /*!< Insertion code of a residue that appears in a site card residue card of a pdb
                                         file >*/
    };
} // namespace PdbFileSpace
