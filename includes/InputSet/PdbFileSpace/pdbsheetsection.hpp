...
namespace PdbFileSpace
{
    ...
    class PdbSheetSection
    {
      ...
      private:
        ...
        //                        ATTRIBUTES                    //
        //////////////////////////////////////////////////////////
        std::string record_name_; /*!< Name of the sheet card record that appears in the first column of each line of a
                                     pdb file >*/
        SheetCardMap
            sheet_cards_; /*!< All sheet_cards that are in a sheet card of a pdb file in a map data structure >*/
    };
} // namespace PdbFileSpace
