...
// See http://www.wwpdb.org/documentation/file-format-content/format33/sect9.html#ATOM for an explaination of atom
...
namespace PdbFileSpace
{
    class PdbAtomCard
    {
      public:
         ...
         * @param charge
         */
        PdbAtomCard(int atom_serial_number, std::string atom_name, char atom_alternate_location,
         ...
         * @param atom_alternate_location
         */
        PdbAtomCard(char chain_id, std::string atom_name, std::string residue_name, int residue_sequence_number,
      ...
      private:
        ...
        std::vector<PdbAtomCard*>
            alternate_atom_locations_; /*!< Alternate atom locations, as a vector of atom cards, as there is
