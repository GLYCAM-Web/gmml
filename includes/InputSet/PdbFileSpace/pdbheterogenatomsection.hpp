...
namespace PdbFileSpace
{
    ...
    class PdbHeterogenAtomSection
    {
      public:
        ...
        /*! \fn
         * An accessor function in order to access to the heterogen atoms in the heterogen atom card in the order of the
         * original pdb file
        ...
        /*! \fn
         * A mutator function in order to set the heterogen atoms of the current object in the order of the original pdb
         * file Set the ordered_heterogen_atom_cards_ attribute of the current heterogen atom card
