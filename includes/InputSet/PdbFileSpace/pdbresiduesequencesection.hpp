...
namespace PdbFileSpace
{
    ...
    class PdbResidueSequenceSection
    {
      ...
      private:
        ...
        //                        ATTRIBUTES                    //
        //////////////////////////////////////////////////////////
        std::string record_name_; /*!< Name of the residue sequence record which is the first column in each line of a
                                     pdb file >*/
        ResidueSequenceCardMap
            residue_sequence_chains_; /*!< Mapping of all residue sequences with chain identifier as the key >*/
    };
} // namespace PdbFileSpace
