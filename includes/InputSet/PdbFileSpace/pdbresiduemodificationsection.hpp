...
namespace PdbFileSpace
{
    ...
    class PdbResidueModificationSection
    {
      ...
      private:
        ...
        //////////////////////////////////////////////////////////
        std::string
            record_name_; /*!< Record name of this card appears in the first column of each line in a pdb file >*/
        ResidueModificationCardMap
            residue_modification_cards_; /*!< Residue modification object map consists of all residue modification
                                            objects in the residue modification card of a pdb file >*/
    };
} // namespace PdbFileSpace
