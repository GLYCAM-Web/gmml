    ...
    class PdbObsoleteSection
    {
      public:
        ...
        PdbObsoleteSection(const std::string& record_name, const std::string& continuation,
                           const std::string& replacement_date, const std::vector<std::string>& identifier_codes);
        /*! \fn
         * Constructor with required parameters
         * @param stream_block
         */
      ...
      private:
        ...
        std::vector<std::string>
            identifier_codes_;              /*!< ID Codes of replacement PDB entries of obsolete card in a pdb file >*/
