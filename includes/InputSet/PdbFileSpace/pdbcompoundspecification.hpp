...
namespace PdbFileSpace
{
    class PdbCompoundSpecification
    {
      public:
         ...
         */
        PdbCompoundSpecification(const std::string& molecule_id, const std::string& molecule_name,
                                 const std::vector<std::string>& chain_ids, const std::string& fragment,
                                 const std::vector<std::string>& molecule_synonyms,
                                 std::vector<std::string>& enzyme_commission_numbers, bool is_engineered,
                                 bool has_mutation, const std::string& comments);
        /*! \fn
         * A constructor that get a stream block of compound specifications and parse the whole block to fill the
         * related fields
