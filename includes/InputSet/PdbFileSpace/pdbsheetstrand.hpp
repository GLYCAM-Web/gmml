...
namespace PdbFileSpace
{
    ...
    class PdbSheetStrand
    {
      public:
         ...
         * @param previous_atom
         */
        PdbSheetStrand(const SheetStrandResidueVector strand_residues, PdbSheetStrandSense sense,
      ...
      private:
        ...
        PdbSheetStrandSense
            sense_; /*!< Sense variable which indicates interaction of strands to each other in a sheet >*/
