...
namespace PdbFileSpace
{
    class PdbConnectSection
    {
      public:
        ...
        //////////////////////////////////////////////////////////
        /*! \typedef
         * A mapping between a specific atom serial number and its bonded atoms serial numbers in a connect card of a
         * pdb file
         */
      ...
      private:
        ...
        BondedAtomsSerialNumbersMap
            bonded_atom_serial_numbers_; /*!< Map of bonded atoms to a specific atom by its serial number */
    };
} // namespace PdbFileSpace
