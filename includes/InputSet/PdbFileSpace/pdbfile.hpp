    ...
    class PdbFile : public InputFile
    {
      public:
        ...
        PdbAtomCard* GetAtomOfResidueByName(PdbResidue* residue, std::string atom_name,
                                            PdbResidueAtomsMap residue_atom_map);
        /*! \fn
         * An accessor function in order to access to atom of a residue of the current object using the atom name
         * @param residue The given residue to return one of its atoms
         * @param atom_name The atom name of the desired atom object
        ...
        /*! \fn
         * A finction that returns chain id and sequence number of a residue that has been placed after a residue that
         * has no tail or has at least 2 tails
         * @return A 2-D vector of chain id and sequence number of residues that have been placed after residues that
         * have no tail or have at least 2 tails
         */
         ...
         * @param model_number Selected model number from the multiple models that are in a pdb file
         */
        void UpdateResidueNameWithTheGivenModelNumber(PdbResidue* residue, std::string residue_name,
                                                      int model_number = 1);
        /*! \fn
         ...
         * @param model_number Selected model number from the multiple models that are in a pdb file
         */
        void SplitAtomCardOfModelCardWithTheGivenModelNumber(char split_point_chain_id, int split_point_sequence_number,
                                                             int model_number = 1);
        /*! \fn
      ...
      private:
        ...
        PdbSerialNumberMapping serial_number_mapping_;     /*!< A map that keeps track of serial numbers that have been
                                                              changed during a process >*/
        PdbSequenceNumberMapping sequence_number_mapping_; /*!< A map that keeps track of sequence numbers that have
                                                              been changed during a process >*/
