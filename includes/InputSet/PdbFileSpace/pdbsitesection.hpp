...
namespace PdbFileSpace
{
    ...
    class PdbSiteSection
    {
      ...
      private:
        ...
        //                       ATTRIBUTES                     //
        //////////////////////////////////////////////////////////
        std::string record_name_; /*!< Name of the record for site card that appears in first column of each line of a
                                     pdb file >*/
        PdbSiteCardMap residue_site_cards_; /*!< Mapping of all site ids in a pdb file and their corresponding site
                                               residue object >*/
    };
} // namespace PdbFileSpace
