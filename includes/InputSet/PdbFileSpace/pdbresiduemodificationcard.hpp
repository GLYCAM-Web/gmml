...
namespace PdbFileSpace
{
    class PdbResidueModificationCard
    {
      public:
         ...
         */
        PdbResidueModificationCard(const std::string& id_code, const std::string& residue_name, char chain_id,
                                   int sequence_number, char insertion_code, const std::string& standard_residue_name,
