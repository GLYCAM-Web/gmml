...
namespace PdbFileSpace
{
    ...
    class PdbAtomSection
    {
      public:
        ...
        void InsertAtomCard(PdbAtomCard* insertionCard,
                            PdbAtomCard* referenceCard = nullptr); // can pass no ref, defaults to add at end
                                                                   /** @}*/
        //////////////////////////////////////////////////////////
        //                        FUNCTIONS                     //
        //////////////////////////////////////////////////////////
      ...
      private:
        ...
        PdbAtomMap atomCardMap_; /*!< Map of all atom cards information that belong to a specific model in a pdb file by
