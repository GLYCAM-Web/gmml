...
namespace TopologyFileSpace
{
    ...
    class TopologyFile
    {
      public:
        ...
        /*! \fn
         * An accessor function in order to access to the boolean attribute that indicates if topology file has
         * perturbation
        ...
        /*! \fn
         * An accessor function in order to access to the boolean attribute that indicates if topology file has standard
         * periodic box
        ...
        /*! \fn
         * An accessor function in order to access to the boolean attribute that indicates if topology file has CAP
         * option
         ...
         * @param number_of_bonds_including_hydrogen The numberof bonds including hydrogen attribute of the current
         * object
         */
         ...
         * @param number_of_angles_including_hydrogen The number of angles including hydrogen attribute of the current
         * object
         */
         ...
         * @param number_of_dihedrals_including_hydrogen The number of dihedrals including hydrogen attribute of the
         * current object
         */
         ...
         * @param number_of_bonds_excluding_hydrogen The number of bonds excluding hydrogen attribute of the current
         * object
         */
         ...
         * @param number_of_angles_excluding_hydrogen The number of angles excluding_hydrogen attribute of the current
         * object
         */
         ...
         * @param number_of_dihedrals_excluding_hydrogen The number of dihedrals excluding hydrogen attribute of the
         * current object
         */
         ...
         * @param number_of_atom_types_in_parameter_file The number of atom types in parameter file attribute of the
         * current object
         */
         ...
         * @param number_of_distinct_hydrogen_bonds The number of distinct hydrogen bonds attribute of the current
         * object
         */
         ...
         * @param number_of_dihedrals_group_perturbed The number of dihedrals group perturbed attribute of the current
         * object
         */
         ...
         * @param number_of_atoms_in_largest_residue The number of atoms in largest residue attribute of the current
         * object
         */
         ...
         */
        template<typename T> std::vector<T> ParsePartition(std::stringstream& stream);
        /*! \fn
         ...
         */
        template<typename T> std::vector<T> PartitionLine(std::string line, std::string format);
        /*! \fn
