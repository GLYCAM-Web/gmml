...
namespace TopologyFileSpace
{
    class TopologyAtom
    {
      public:
         ...
         * @param tree_chain_classification Tree chain classification of the atom in order to extract bonding
         * information of the atoms in a residue
         * @param residue_name Name of the residue that the atom belongs to
         */
        TopologyAtom(int atom_index, std::string atom_name, std::string type, double atom_charge, int atomic_number,
                     double atom_mass, ExcludedAtomNames excluded_atoms, int number_of_excluded_atoms, double radii,
                     double screen, std::string tree_chain_classification, std::string residue_name);
      ...
      private:
        ...
        std::vector<std::string>
            excluded_atoms_; /*!< List of atom names that are excluded from interaction with the current atom >*/
        ...
        std::string tree_chain_classification_; /*!< Tree chain classification of the atom appears in a topology file in
                                                   order to extract the bonding information inside a residue >*/
