...
namespace TopologyFileSpace
{
    ...
    class TopologyResidue
    {
      public:
         ...
         * @param starting_atom_index Index of the first atom that belongs to the residue among all atoms in a topology
         * file
         */
        ...
        /*! \fn
         * An accessor function in order to access whether a residue is a Solvent, returns true if a residue is a
         * solvent.
      ...
      private:
        ...
        int starting_atom_index_;  /*!< Index of the first atom belongs to this residue among all other atoms in a
                                      topology file >*/
