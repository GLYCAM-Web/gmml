...
namespace gmml
{
 ...
 // Other
  ...
  //{ "Type_1" , "Type_2" , "Length" , "Note" },
                ...
                { "P", "O2",  1.480,                                                                  "Parm10"},
                { "S", "Os",  1.589,
                 "K calculated from methyl sulphate (eqm value from THEOCHEM 395/396 (1997) 107-122)"         },
                { "S", "O2",  1.440,
                 "K calculated from methyl sulphate (eqm value from THEOCHEM 395/396 (1997) 107-122)"         },
                { "C", "Os",  1.323,                                                                  "Parm99"},
                ...
                {"Cg", "Os",  1.460,
                 "Parm94   K calculated from methyl sulphate (eqm value from THEOCHEM 395/396 (1997) 107-122)"},
