...
public:
    ...
    DihedralAngleDataVector GetEntriesForLinkage(const std::string atom1Name, const std::string residue1Name, const std::string atom2Name, const std::string residue2Name) const;
private:
    //////////////////////////////////////////////////////////
    //                    PRIVATE FUNCTIONS                 //
    //////////////////////////////////////////////////////////
