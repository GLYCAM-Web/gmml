#ifndef GMML_INCLUDES_MOLECULARMETADATA_GLYCAM_DIHEDRALANGLEDATA_HPP
#define GMML_INCLUDES_MOLECULARMETADATA_GLYCAM_DIHEDRALANGLEDATA_HPP
...
struct DihedralAngleData
{
    ...
    std::string atom3_ ;
    std::string atom4_ ;
    inline std::string  print() { return atom1_ + "_" + atom2_ + "_" + atom3_ + "_" + atom4_ + " : " + rotamer_name_;  }
...
#endif // GMML_INCLUDES_MOLECULARMETADATA_GLYCAM_DIHEDRALANGLEDATA_HPP
