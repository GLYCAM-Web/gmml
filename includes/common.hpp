...
"NHID", "NHIE", "CNALA", "CNASP",
    ...
    const std::string NUCLEICACIDS[] = {
      "02I","05A","05H","05K","0A", "0AD","0AP", "0C","0DA","0DC",
      "0DG","0DT", "0G","0KZ","0R8", "0U","0U1","10C","125","126",
      "127","128","12A","16B","18M","18Q","1AP","1CC","1DP","1FC",
      "1MA","1MG","1PR","1RN","1SC","1TL","1TW","1W5","1WA","23G",
      "2AR","2AT","2AU","2BD","2BT","2BU","2DA","2DF","2DM","2DT",
      "2EG","2FE","2FI","2GF","2GT","2IA","2JU","2JV","2L8","2LA",
      "2LF","2MA","2MG","2MU","2NT","2OM","2OT","2PR","2SA","2SG",
      "2ST","31H","31M","3AU","3DA","3DR","3ME","3TD","3ZO","45A",
      "47C","4AC","4DG","4DU","4E9","4EN","4MF","4OC","4PC","4PD",
      "4PE","4SC","4SU","4TA","4U3","50L","50N","56B","574","5AA",
      "5AT","5BU","5CF","5CG","5CM","5DB","5EJ","5FA","5FC","5FU",
      "5HC","5HM","5HT","5HU","5IC","5IU","5JO","5MC","5MD","5MU",
      "5NC","5OC","5PC","5PY","5SE","5UA","63G","63H","64P","64T",
      "68Z","6F7","6FC","6FK","6FM","6FU","6HA","6HB","6HC","6HG",
      "6HT","6IA","6MA","6MI","6MZ","6NW","6OG","6OO","6OP","6PO",
      "70U","73W","75B","77Y","7AT","7BG","7DA","7GU","7MG","7OK",
      "7S3","7SN","85Y","8AA","8AG","8AH","8AN","8AZ","8BA","8DT",
      "8FG","8MG","8NI","8OG","8OS","8PI","8PY","8RJ","8RO","8Y9",
      "8YN","92F","93D","94O","9O4","9QV","9SI","9SY","9V9",  "A",
      "A23","A2L","A2M","A38","A3A","A3P","A40","A43","A44","A47",
      "A5L","A5M","A5O","A6A","A6C","A6G","A6U","A7C","A7E","A9Z",
      "AAB","ABR","ABS","ABT","AD2","ADX","AET","AF2","AFF","AFG",
      "AP7", "AS","ASU","ATD","ATL","ATM","AVC","AWC","B7C","B8H",
      "B8K","B8N","B8Q","B8T","B8W","B9B","B9H","BGH","BGM","BMN",
      "BMP","BMQ","BOE","BRU","BT5","BVP","BZG",  "C","C2L","C2S",
      "C31","C34","C36","C37","C38","C42","C43","C45","C46","C49",
      "C4J","C4S","C5L","C6G","C7R","C7S","CAR","CBR","CBV","CCC",
      "CDW","CFL","CFZ","CG1","CGY", "CH","CJ1","CM0","CMR","CNU",
      "CP1","CS8","CSF","CSL","CSM","CTG","CVC","CX2","D00", "D3",
      "D33","D3N","D3T","D4B","D4M", "DA","DBM", "DC","DCT","DCZ",
      "DDG","DDN","DDX","DFT","DG", "DG8","DGI", "DI","DJF", "DN",
      "DNR","DOC", "DP","DPB","DPY","DRM","DRP","DRZ", "DT", "DU",
      "DUZ", "DX","DXD", "DZ","DZM",  "E","E1X","E3C","E6G","E7G",
      "EAN","EDA","EDC","EDI","EHG","EIT","ENA","ENP","ENQ","EQ0",
      "EQ4","EW3","EWC","EXC","F2T","F3H","F3N","F3O","F4H","F4Q",
      "F5H","F6H","F6U","F6X","F73","F74","F7H","F7K","F7O","F7R",
      "F7X","FA2","FA5","FAG","FAI","FAX","FDG","FFD","FHU","FMG",
      "FMU","FNU","FOX",  "G","G2L","G2S","G31","G35","G36","G38",
      "G46","G47","G48","G49","G4P","G7M","GAO","GCK","GDO","GDP",
      "GDR","GF2","GFL","GH3","GMS","GMU","GMX","GN7","GNE","GOM",
      "GRB", "GS","GSR","GSS","GX1","H2U","HEU","HN0","HN1","HOL",
        "I","I2T","I4U", "IC", "IG","IGU","IMC","IOO","IPN","IRN",
       "IU","J0X","J4T","JDT","JLN","JMH","JSP","JW5","K2F","K39",
      "KAG","KAK","KGV","L3X","LCA","LCC","LCG","LGP","LHH","LHO",
      "LKC","LMS","LSH","LST","LTP","LV2","LWM","M1G","M1Y","M2G",
      "M3O","M5M","M7A","MA6","MA7","MBZ","MCY","MDJ","MDK","MDQ",
      "MDR","MDU","MDV","ME6","MF7","MFO","MFT","MG1","MGQ","MGV",
      "MHG","MIA","MM7","MMT","MMX","MNU","MRG","MTR","MTU","MUM",
        "N","N4S","N5I","N5M","N6G","N7X","NCU","NCX","NDN","NDU",
      "NF2","NMS","NMT","NP3","NR1","NRI","NTT","NYM","O2C","O2G",
      "O2Z","OAD","ODP","OFC","OGX","OHU","OKN","OKQ","OKT","OMC",
      "OMG","OMU","ONE","OOB","OWR","OYW",  "P","P2T","P2U","P4U",
      "P5P","P7G","P9G","PBT","PDU","PGN","PGP","PMT","PPU","PPW",
      "PQ1","PRN","PST","PSU","PU", "PUY","PVX","PYO","PYY","PZG",
      "QBT","QCK","QSK","QSQ","QUO",  "R","RBD","RCE","RDG","RFJ",
      "RIA","RMP","RPC","RSP","RSQ","RTP","RUS", "RY","S2M","S4A",
      "S4C","S4G","S6G","S6M","S8M","SAY", "SC","SDE","SDG","SDH",
      "SMP","SMT","SOS","SPT","SRA","SSU","SUR","T0N","T0P","T0Q",
      "T0T","T2S","T2T","T32","T38","T39","T3P","T41","T48","T49",
      "T4S","T5O","T5S","T64","T6A","TA3","TAF","TAL", "TC","TC1",
      "TCJ","TCP","TCY","TDY","TED","TFE","TFF","TFO","TFT", "TG",
      "TGP","THM","THP","THX","TLB","TLC","TLN","TP1","TPC","TPG",
      "TSP", "TT","TTD","TTI","TTM","TX2","TYU",  "U","U23","U2L",
      "U2P","U31","U33","U34","U36","U37","U48","U4M","U5M","U7B",
      "U8U","UAR","UBD","UBI","UCL","UD5","UDP","UF2","UFB","UFP",
      "UFR","UFT","UMS","UMX","UOA","UOB","UPE","UPS","UPV","UR3",
      "URD","URT","URU","URX","US1","US2","US3","US4","US5","USM",
      "UVX","UY1","UY4","V3L","VC7","VET","WC7","X4A","XAD","XAE",
      "XAL","XAR","XCL","XCR","XCS","XCT","XCY","XFC","XGA","XGL",
      "XGR","XGU","XNY","XPB","XTF","XTH","XTL","XTR","XTS","XTY",
      "XUA","XUG",  "Y","Y5P","YA4","YCO", "YG","YRR","YYG",  "Z",
      "ZAD","ZBC","ZBU","ZCY","ZDU","ZGU","ZHP"
    };

    const int NUCLEICACIDSSIZE = (sizeof(NUCLEICACIDS) / sizeof(NUCLEICACIDS[0])); 

    const std::string SACCHARIDES[] = {
      "05L","07E","07Y","08U","09X","0BD","0H0","0HX","0LP","0MK",
      "0NZ","0V4","0WK","0XY","0YT","10M","12E","145","147","149",
      "14T","15L","16F","16G","16O","17T","18D","18O","18T","1AR",
      "1BW","1CF","1GL","1GN","1JB","1S3","1S4","1SD","1X4","20X",
      "22O","22S","23V","24S","25E","26M","26O","26Q","26R","26V",
      "26W","26Y","27C","289","291","293","2DG","2DR","2F8","2FG",
      "2FP","2GL","2GS","2H5","2HA","2M5","2M8","2WP","32O","34V",
      "3BU","3CM","3DO","3DY","3FM","3GR","3HD","3J3","3J4","3LJ",
      "3LR","3MF","3MG","3MK","3R3","3S6","3YW","42D","445","44S",
      "46D","46M","46Z","475","48Z","491","49A","49S","49T","49V",
      "4AM","4GL","4GP","4JA","4N2","4NN","4QY","4R1","4SG","4UZ",
      "4V5","50A","510","51N","56N","57S","5DI","5GF","5II","5KQ",
      "5KS","5KT","5KV","5L2","5L3","5LS","5LT","5MM","5N6","5QP",
      "5RP","5SP","5TH","5TJ","5TK","5TM","604","61J","62I","64K",
      "66O","6BG","6C2","6GP","6GR","6K3","6KH","6KL","6KS","6KU",
      "6KW","6LA","6LS","6LW","6MJ","6MN","6PG","6PY","6PZ","6S2",
      "6SA","6UD","6Y6","6YR","6ZC","73E","79J","7CV","7D1","7GP",
      "7JZ","7K2","7K3","7NU","7SA","83Y","89Y","8B9","8EX","8GA",
      "8GG","8GP","8I4","8LM","8LR","8OQ","8PK","8S0","8YV","95Z",
      "96O","98U","9AM","9C1","9CD","9GP","9KJ","9MR","9OK","9PG",
      "9QG","9S7","9SG","9SJ","9SM","9SP","9T1","9T7","9VP","9WJ",
      "9WN","9WZ","9YW","A0K","A1Q","A2G","A5C","A6P","AAL","AAO",
      "ABC","ABE","ABF","ABL","AC1","ACG","ADA","ADR","AF1","AFD",
      "AFO","AFP","AFR","AGH","AGL","AH2","AH8","AHG","AHM","AHR",
      "AIG","ALL","ALX","AMG","AMN","AMU","AMV","ANA","AOG","AOS",
      "AQA","ARA","ARB","ARE","ARI","ARW","ASC","ASG","ASO","AXP",
      "AXR","AY9","AZC","B0D","B16","B1H","B1N","B6D","B7G","B8D",
      "B9D","BBK","BBV","BDF","BDG","BDP","BDR","BEM","BFN","BG6",
      "BG8","BGC","BGL","BGN","BGP","BGS","BHG","BM3","BM7","BMA",
      "BMX","BND","BNG","BNX","BO1","BOG","BQY","BS7","BTG","BW3",
      "BWG","BXF","BXX","BXY","BZD","C3B","C3G","C3X","C4B","C4W",
      "C4X","C5X","CAP","CBF","CDR","CEG","CEZ","CGF","CJB","CKB",
      "CKP","CNP","CR1","CR6","CRA","D1M","D5E","D6G","DAF","DAG",
      "DAN","DDA","DDL","DEG","DFR","DFX","DGD","DGO","DGS","DGU",
      "DIG","DJB","DJE","DK4","DKX","DKZ","DL6","DLF","DLG","DMU",
      "DNO","DO8","DPC","DQQ","DR4","DRI","DSR","DT6","DVC","DYM",
      "E3M","E4P","E5G","EAG","EBG","EBQ","EEN","EEQ","EGA","EJT",
      "EMP","EMZ","EPG","EQP","EQV","ERE","ERI","ETT","EUS","F1P",
      "F1X","F55","F58","F6P","F8X","FBP","FCA","FCB","FDP","FDQ",
      "FFX","FIF","FIX","FK9","FKD","FMF","FNG","FRU","FSA","FSI",
      "FSR","FSW","FUB","FUC","FUD","FUF","FUL","FUY","FVQ","FX1",
      "FYJ","G0S","G16","G1P","G20","G28","G2F","G3F","G3I","G4D",
      "G4S","G6D","G6P","G6S","G7P","G8Z","GAA","GAD","GAF","GAL",
      "GAT","GBH","GC1","GC4","GC9","GCB","GCD","GCN","GCO","GCS",
      "GCT","GCU","GCV","GCW","GDA","GDL","GE1","GE3","GFP","GIV",
      "GL0","GL1","GL2","GL4","GL5","GL6","GL7","GL9","GLA","GLC",
      "GLD","GLF","GLG","GLO","GLP","GLS","GLT","GM0","GMB","GMH",
      "GMT","GMZ","GN1","GN4","GNS","GNX","GP0","GP1","GP4","GPH",
      "GPK","GPM","GPQ","GPU","GPV","GPW","GQ1","GRF","GRX","GS1",
      "GS9","GTK","GTM","GTR","GU0","GU1","GU2","GU3","GU4","GU5",
      "GU6","GU8","GU9","GUF","GUL","GUP","GUZ","GXL","GXV","GYE",
      "GYG","GYP","GYU","GYV","GZL","H1M","H2P","H53","H6Q","H6Z",
      "HBZ","HD4","HDL","HMS","HNV","HNW","HSG","HSH","HSJ","HSQ",
      "HSX","HSY","HTG","HTM","HVC","I57","IDC","IDF","IDG","IDR",
      ...
      "KO2","KOT","KTU","L6S","L6T","LAG","LAH","LAI","LAO","LCN",
      "LDY","LEC","LER","LFC","LFR","LGC","LGU","LKA","LKS","LM2",
      "LMO","LMT","LMU","LNV","LOG","LOX","LPK","LRH","LSM","LTG",
      "LTM","LVO","LVZ","LXB","LXC","LXZ","LZ0","M1P","M2F","M3N",
      "M55","M6D","M6P","M7B","M7P","M8C","MA1","MA2","MA3","MA8",
      "MAF","MAG","MAN","MAT","MAV","MAW","MBE","MBF","MBG","MCU",
      "MDA","MDP","MFB","MFU","MG5","MGC","MGL","MGS","MJJ","MMA",
      "MMN","MN0","MNA","MQG","MQT","MRH","MRP","MSX","MUB","MUG",
      "MUR","MXY","MXZ","MYG","N1L","N3U","NA1","NAA","NAG","NBG",
      "NBX","NBY","NDG","NFG","NG1","NG6","NGA","NGB","NGC","NGE",
      "NGF","NGK","NGS","NGY","NGZ","NHF","NM6","NM9","NNG","NPF",
      "NSQ","NTF","NXD","O1G","OAK","OEL","OI7","OPM","ORP","OTG",
      "OTN","OTU","OX2","P53","P6P","P8E","PA1","PA5","PAV","PDX",
      "PH5","PKM","PNA","PNG","PNJ","PNW","PPC","PRP","PSG","PSJ",
      "PSV","PTQ","PUF","PZU","QDK","QIF","QV4","R1P","R1X","R2B",
      "R2G","R5P","RAE","RAM","RAO","RAT","RB5","RBL","REL","RER",
      "RF5","RG1","RGG","RHA","RHC","RI2","RIB","RIP","RM4","RNS",
      "RNT","ROR","RP3","RP5","RP6","RPA","RR7","RRJ","RRY","RST",
      "RTG","RTV","RUB","RUG","RUU","RVG","RVM","RWI","RY7","RZM",
      "S6P","S7P","S81","SA0","SCG","SDD","SDY","SEJ","SF6","SF9",
      "SFJ","SFU","SG4","SG5","SG6","SG7","SGA","SGC","SGD","SGN",
      "SGS","SHB","SHD","SHG","SI3","SIA","SID","SIO","SIZ","SLB",
      "SLM","SN5","SNG","SOE","SOG","SOL","SOR","SR1","SSG","SSH",
      "STZ","SUS","SZZ","T68","T6T","TA6","TAG","TEU","TFU","TGA",
      "TGK","TGR","TGY","TH1","TM9","TMR","TMX","TNX","TOA","TOC",
      "TQY","TRV","TS8","TT7","TTV","TTZ","TU4","TUG","TUJ","TUP",
      "TVD","TVG","TVM","TVS","TVV","TVY","TW7","TWA","TWD","TWJ",
      "TWY","TXB","TYV","U1Y","U2A","U2D","U8V","U97","U9A","U9D",
      "U9G","U9J","U9M","UAP","UBH","UBO","UDC","UEA","V3M","V3P",
      "V71","VG1","VJ1","VJ4","VKN","VTB","WIA","WOO","WUN","X0X",
      "X1P","X1X","X2F","X2Y","X34","X6X","X6Y","XBP","XDP","XDX",
      "XGP","XIL","XKJ","XLF","XLS","XMM","XUL","XXM","XXR","XXX",
      "XYB","XYF","XYL","XYP","XYS","XYZ","YIO","YKR","YO5","YX0",
      "YX1","YYB","YYH","YYJ","YYK","YYM","YYQ","YZ0","YZT","Z0F",
      "Z15","Z16","Z2D","Z2T","Z3K","Z3L","Z3Q","Z3U","Z4K","Z4R",
      "Z4S","Z4U","Z4V","Z4W","Z4Y","Z57","Z5J","Z5L","Z61","Z6H",
      "Z6J","Z6W","Z8H","Z8T","Z9D","Z9E","Z9H","Z9K","Z9L","Z9M",
      "Z9N","Z9W","ZB0","ZB1","ZB2","ZB3","ZCD","ZCZ","ZD0","ZDC",
