...
namespace PrepFileSpace
{
    ...
    class PrepFileResidue
    {
      public:
        ...
        /*! \fn
         * A function to parse improper dihedral section and extraxt improper dihedral information of the residue from a
         * given file stream
        ...
        /*! \fn
         * Convert the value of CoordinateType attribute of the current object (coordinate_type_) to the string version
         * of it
        ...
        /*! \fn
         * Convert the value of OutputFormat attribute of the current object (output_format_) to the string version of
         * it
        ...
        /*! \fn
         * Convert the value of GeometryType attribute of the current object (geometry_type_) to the string version of
         * it
        ...
        /*! \fn
         * Convert the value of DummyAtomPosition attribute of the current object (dummy_atom_position_) to the string
         * version of it
        ...
        /*! \fn
         * Convert the value of DummyAtomOmission attribute of the current object (dummy_atom_omission_) to the string
         * version of it
         ...
         * (Converts internal coordinates to cartesian coordinates and then extracts bonding atoms to each one based on
         * tree chain classification of each atom in the residue)
        ...
        std::string
            name_; /*!< Residue name; fill by the first column of the 3rd line of each residue section of the file */
        CoordinateType coordinate_type_; /*!< Coordinate type(INT, XYZ); fill by the 2nd column of the third line of
                                            each residue section of the file */
        OutputFormat output_format_; /*!< Output format(Binary=1,Formatted=1); fill by the third column of the 3rd line
                                        of each residue section of the file */
        GeometryType geometry_type_; /*!< Geometry type(CORRECT, CHANGE); fill by the first column of the 4th line of
                                        each residue section of the file */
        DummyAtomOmission dummy_atom_omission_; /*!< Dummy atom omission(OMIT, NOMIT); fill by the 3rd column of the 4th
                                                   line of each residue section of the file */
        std::string dummy_atom_type_; /*!< Dummy atom type; fill by the 4th column of the 4th line of each residue
                                         section of the file */
        DummyAtomPosition dummy_atom_position_; /*!< Dummy atom position(ALL, BEG); fill by the 5th column of the 4th
                                                   line of each residue section of the file */
        double charge_; /*!< Total charge of the residue; fill by the 5th line of each residue section of the file */
        PrepFileAtomVector atoms_; /*!< Atoms in the resisue; fill by all lines between 6th line of each residue section
                                      of the file and a blank line in that section */
        DihedralVector improper_dihedrals_; /*!< Improper dihedrals; fill by all lines between IMPROPER title in each
                                               residue section of the file and a blank line in that section */
        Loop loops_; /*!< Loops; fill by all lines between LOOP title in each residue section of the file and a blank
