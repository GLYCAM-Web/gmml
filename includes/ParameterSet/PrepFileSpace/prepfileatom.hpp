...
namespace PrepFileSpace
{
    ...
    class PrepFileAtom
    {
      public:
         ...
         * @param topological_type Topological type of the atom in its residue that can be used to extract residue
         * structure
         ...
         */
        PrepFileAtom(int index, const std::string& name, const std::string& type,
        ...
        /*! \fn
         * Constructor that extracts information of the atom from the given line from the atom section of each residue
         * in a prep file
        ...
        /*! \fn
         * Convert the value of TopologicalType attribute of the current object (topological_type_) to the string
         * version of it
        ...
        gmml::TopologicalType topological_type_; /*!< Topological type (for chain extraction of the residue); fill by th
                                                    4th column of the residue section of the file */
