...
namespace LibraryFileSpace
{
    class LibraryFileAtom
    {
      public:
         ...
         */
        LibraryFileAtom(std::string type, std::string name, int residue_index, int atom_index, int atomic_number,
                        double charge);
        /*! \fn
         ...
         */
        LibraryFileAtom(std::string type, std::string name, int residue_index, int atom_index, int atomic_number,
                        double charge, GeometryTopology::Coordinate coordinate, std::vector<int> bonded_atoms_indices,
                        int atom_order);
      ...
      private:
        ...
        int residue_index_; /*!< Residue index that the atom belongs to; Set by the 4th column of the atom section of a
                               library file (this number should indicates the index of the residue in the index section
                               of the library file but it could be a wrong number) */
        int atom_index_; /*!< Index of the atom in the belonging residue; Set by the 6th column of the atom section of a
                            library file */
        ...
        GeometryTopology::Coordinate coordinate_; /*!< Coordinate of the atom; Set by the corresponding line in the
                                                     positions section of a library file */
        std::vector<int> bonded_atoms_indices_;   /*!< List of atom indices that are bonded to the atom;
                                                          Set by the corresponding atom index in the connectivity section
                                                     of a library file */
        int atom_order_; /*!< Order of atoms of the residue in the atom section; Set by a line counter iterates on lines
                            of the atom section of a library file */
    };
} // namespace LibraryFileSpace
