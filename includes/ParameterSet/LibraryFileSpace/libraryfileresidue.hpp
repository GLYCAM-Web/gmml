...
namespace LibraryFileSpace
{
    ...
    class LibraryFileResidue
    {
      public:
         ...
         */
        LibraryFileResidue(std::string& name, int listing_index, std::vector<LibraryFileAtom*>& atoms,
                           int head_atom_index, int tail_atom_index, double box_angle = 0, double box_length = 0,
                           double box_width = 0, double box_height = 0);
      ...
      private:
        ...
        AtomMap atoms_;       /*!< List of atoms belonging to the residue mapped to their order numbers; set by various
                                 sections (atom, connectivity, positions) of a library file*/
