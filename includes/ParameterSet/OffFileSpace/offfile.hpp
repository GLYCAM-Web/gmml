...
namespace OffFileSpace
{
    ...
    class OffFile
    {
      public:
         ...
         */
        void PopulateOffFileResiduesFromAssembly(MolecularModeling::ResidueVector assembly_residues,
                                                 int CoordinateIndex);
        /*! \fn
         ...
         * @param stream Output stream
         */
        void WritePositionSection(std::ofstream& stream, MolecularModeling::ResidueVector assembly_residues,
                                  int CoordinateIndex);
