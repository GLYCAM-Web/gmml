...
namespace OffFileSpace
{
    ...
    class OffFileResidue
    {
      ...
      private:
        ...
        OffFileAtomVector atoms_; /*!< List of atoms belonging to the residue mapped to their order numbers; set by
                                     various sections (atom, connectivity, positions) of a Off file*/
