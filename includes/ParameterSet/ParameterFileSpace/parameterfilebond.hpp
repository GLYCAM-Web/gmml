...
namespace ParameterFileSpace
{
    class ParameterFileBond
    {
      public:
         ...
         */
        ParameterFileBond(const std::vector<std::string>& types, double force_constant, double length,
      ...
      private:
        ...
        //                         ATTRIBUTES                   //
        //////////////////////////////////////////////////////////
        std::vector<std::string> types_; /*!< Atom types involved in a bond; Fill by the first column of the third
                                            section of the parameter file split by '-'*/
        double force_constant_;          /*!< Bond force constant; Fill by the second column of the third section of the
                                            parameter file*/
        ...
        /*!< A sample of the third (Bond) section of the parameter file: C -C   310.0    1.525       Junmei et al,
         * 1999*/

        std::vector<double>
            hbond_coefficients_; /*!< Hydrogen bond coefficients; Fill by the 7th section of the parameter file*/
        /*!< A sample of the 7th (hydrogen bond) section of the parameter file:   HW  OW  0000. 0000. 4.  flag for fast
         * water*/
    };
} // namespace ParameterFileSpace
