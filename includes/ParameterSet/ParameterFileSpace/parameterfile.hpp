...
namespace ParameterFileSpace
{
    ...
    class ParameterFile
    {
      public:
        ...
        /*! \fn
         * An accessor function in order to access to the map of atom types (as string) to their atom objects of the
         * current object
         * @return atom_types_ attribute of the current object of this class
         */
        const AtomTypeMap& GetAtomTypes();
        /*! \fn
         * An accessor function in order to access to the map of bonds (dual string of atom types) to their bond objects
         * of the current object
         * @return bonds_ attribute of the current object of this class
         */
        const BondMap& GetBonds();
        /*! \fn
         * An accessor function in order to access to the map of angles (triple string of atom types) of the current
         * object
         * @return angles_ attribute of the current object of this class
         */
        const AngleMap& GetAngles();
        /*! \fn
         * An accessor function in order to access to the map of dihedrals (fourple string of atom types) of the current
         * object
         * @return path_ attribute of the current object of this class
         */
        ...
        /*! \fn
         * A function that parses a description of a line in dihedral section of the current object to extract double
         * value of the given key Process the description of a line in dihedral section of the parameter file
        ...
        /*! \fn
         * A function that writes back a main parameter file (mostly indicates as dat file) content into an output
         * stream
         * @param out_stream Main parameter file output stream
         */
        void BuildMainParameterFile(std::ofstream& out_stream);
        /*! \fn
         * A function that writes back a modified parameter file (mostly indicates as frcmod file) content into an
         * output stream
         * @param out_stream Modified parameter file output stream
         */
        void BuildModifiedParameterFile(std::ofstream& out_stream);
        /*! \fn
         * A function that writes back a modified parameter file containing ions (mostly indicates as frcmod file)
         * content into an output stream
         * @param out_stream Modified parameter file output stream
         */
