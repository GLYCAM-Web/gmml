...
Coordinate CreateMissingCoordinateForTetrahedralAtom(const Coordinate *centralCoord, std::vector<const Coordinate*> threeNeighbors, const double distance = 1.0);
