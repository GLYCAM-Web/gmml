...
{
	// Constructor
    GlycositeInput(std::string proteinResidueId, std::string glycan) : proteinResidueId_ (proteinResidueId), glycanInput_ (glycan) {}
...
{
	std::string prepFileLocation_ = "../dat/prep/GLYCAM_06j-1_GAGS_KDN.prep"; // default when running from test folder
