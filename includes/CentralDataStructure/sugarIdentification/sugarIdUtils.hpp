#ifndef INCLUDES_CENTRALDATASTRUCTURE_SUGARIDENTIFICATION_SUGARIDUTILS_HPP_
#define INCLUDES_CENTRALDATASTRUCTURE_SUGARIDENTIFICATION_SUGARIDUTILS_HPP_
...
// Depending on what the use case is, this is probably better as an unordered map with the chemical_code_string as the
// key, and the value is a struct with the rest of the info? I bet there is some funky stuff going on when looking up
// info here
...
const Glycan::SugarName COMPLEXSUGARNAMELOOKUP[] = {
 ...
 ///  Added to fix some warnings. Probably need to be moved to the correct subcategory.
    ...
    {             "_3_4^2MeP_+1d^a",    "a-L-fucopyranose", "LFucpa", "L", "", "P", "a",               "2-O-methyl-a-L-fucopyranose", "LFucp[2Me]a",
     "MXZ"                                                                                                                                                },
    {             "_3_4^2MeP_+1d_a",    "b-L-fucopyranose", "LFucpb", "L", "", "P", "b",               "2-O-methyl-b-L-fucopyranose", "LFucp[2Me]b",
     "MXY"                                                                                                                                                },
    ...
    {             "_3^2NAc^4P_+1^a",   "a-L-glucopyranose", "LGlcpa", "L", "", "P", "a",                  "N-acetyl-a-L-glucosamine",   "LGlcpNAca",
     "NGZ"                                                                                                                                                },
    {             "_2NAc^3^4P_a^+1", "a-D-galactopyranose", "DGalpa", "D", "", "P", "a",                "N-acetyl-a-D-galactosamine",   "DGalpNAca",
     "A2G"                                                                                                                                                },
    {             "_2NAc_3_4P^a^+1",    "b-D-allopyranose", "DAllpb", "D", "", "P", "b",             "N-acetyl-b-D-allopyranosamine",   "DAllpNAcb",
     "NAA"                                                                                                                                                },
    {             "_2NAc_4^3P^a^+1",   "b-D-glucopyranose", "DGlcpb", "D", "", "P", "b",                  "N-acetyl-b-D-glucosamine",   "DGlcpNAcb",
     "NAG"                                                                                                                                                },
    {             "_2NAc^3^4P^a^+1", "b-D-galactopyranose", "DGalpb", "D", "", "P", "b",                "N-acetyl-b-D-galactosamine",   "DGalpNAcb",
     "NGA"                                                                                                                                                },
    {         "_2NAc^3iprA^4P^a^+1",    "b-D-muramic acid", "DMurpb", "D", "", "P", "b",                 "N-acetyl-b-D-muramic acid",   "DMurpNAcb",
     "AMU"                                                                                                                                                },
    {         "_2NAc^3iprA^4P_a^+1",    "a-D-muramic acid", "DMurpa", "D", "", "P", "a",                 "N-acetyl-a-D-muramic acid",   "DMurpNAca",
     "MUB"                                                                                                                                                },
...
#endif /* INCLUDES_CENTRALDATASTRUCTURE_SUGARIDENTIFICATION_SUGARIDUTILS_HPP_ */
