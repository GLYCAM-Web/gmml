...
public:
    ...
    inline cds::Residue* GetFromThisResidue1() const {return from_this_residue1_;}
    inline cds::Residue* GetToThisResidue2() const {return to_this_residue2_;}
    ...
    //                       MUTATOR                        //
    //////////////////////////////////////////////////////////
    inline void SetRotatableDihedrals(std::vector<RotatableDihedral> rotatableDihedrals) {rotatableDihedrals_ = rotatableDihedrals;}
    //////////////////////////////////////////////////////////
    //                       FUNCTIONS                      //
    //////////////////////////////////////////////////////////
...
private:
    ...
    inline cds::Atom* GetFromThisConnectionAtom1() const {return from_this_connection_atom1_;}
    inline cds::Atom* GetToThisConnectionAtom2() const {return to_this_connection_atom2_;}
    inline void SetIfReversedAtomsThatMove(bool b) {reverseAtomsThatMove_ = b;}
    void AddExtraAtomsThatMove(std::vector<cds::Atom*> extraAtoms);
    void InitializeClass(cds::Residue* from_this_residue1, cds::Residue* to_this_residue2, bool reverseAtomsThatMove);
    bool CheckIfViableLinkage() const;
    std::vector<RotatableDihedral> FindRotatableDihedralsConnectingResidues(cds::Atom* from_this_connection_atom1, cds::Atom* to_this_connection_atom2);
    //std::vector<cds::Atom*> DealWithBranchesFromLinkages(std::vector<cds::Atom*> linearLinkageAtoms, Atom *cycle_point1, Atom *cycle_point2);
