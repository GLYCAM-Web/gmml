...
namespace prep
{
    ...
    class PrepResidue : public cds::Residue
    {
      public:
        ...
        // void RecursivelySetConnectivities(std::vector<PrepAtom*>::iterator& currentAtom,
        // std::vector<PrepAtom*>::iterator connectionPoint, std::vector<PrepAtom*>::iterator& lastAtom);
      ...
      private:
        ...
        OutputFormat output_format_     = prep::kFormatted; //!< Output format(Binary=1,Formatted=1); fill by the third
        ...
        DummyAtomOmission dummy_atom_omission_ =
            prep::kOmit; //!< Dummy atom omission(OMIT, NOMIT); fill by the 3rd column of the 4th line of each residue
                         //!< section of the file
        ...
        std::vector<std::pair<std::string, std::string>>
            loops_; //!< Loops; fill by all lines between LOOP title in each residue section of the file and a blank
