...
namespace PdbPreprocessorSpace
{
    class PdbPreprocessorReplacedHydrogen
    {
      public:
         ...
         * @param residue_sequence_number Sequence number of the residue that the removed/replaced hydrogen atom belongs
         * to
         * @param residue_insertion_code Insertion code of the residue that the removed/replaced hydrogen atom belongs
         * to
         * @param residue_alternate_location Alternate location of the residue that the removed/replaced hydrogen atom
         * belongs to
         */
        PdbPreprocessorReplacedHydrogen(char residue_chain_id, int atom_serial_number, std::string atom_name,
      ...
      private:
        ...
        int residue_sequence_number_; /*!< Sequence number of the residue that the removed/replaced hydrogen atom
                                         belongs to >*/
        char residue_chain_id_; /*!< Chain id of the residue that the removed/replaced hydrogen atom belongs to >*/
        char residue_insertion_code_; /*!< Insertion code of the residue that the removed/replaced hydrogen atom belongs
                                         to >*/
        char residue_alternate_location_; /*!< Alternate location of the residue that the removed/replaced hydrogen atom
                                             belongs to >*/
    };
} // namespace PdbPreprocessorSpace
