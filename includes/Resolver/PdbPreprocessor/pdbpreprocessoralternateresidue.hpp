...
namespace PdbPreprocessorSpace
{
    class PdbPreprocessorAlternateResidue
    {
      public:
         ...
         * (Residues with same description and different alternate location attributes are declared as alternate
         * residues)
         ...
         * @param selected_alternate_location List of true/false values corresponding to each alternate location that
         * indicates which one is selected
         */
        PdbPreprocessorAlternateResidue(std::string residue_name, char chain_id, int sequence_number,
                                        char residue_insertion_code, std::vector<char> residue_alternate_location,
      ...
      private:
        ...
        std::vector<char> residue_alternate_location_; /*!< List of alternate locations of the residue with different
                                                          possible location(s) >*/
        std::vector<bool> selected_alternate_location_; /*!< List of true/false values that indicate which one of the
                                                           alternate location(s) is selected >*/
    };
} // namespace PdbPreprocessorSpace
