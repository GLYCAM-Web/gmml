...
namespace PdbPreprocessorSpace
{
    ...
    class PdbPreprocessor
    {
      public:
         ...
         */
        gmml::ResidueNameMap
        GetUnrecognizedResidueNamesMap(PdbFileSpace::PdbFile::PdbPairVectorAtomNamePositionFlag pdb_residue_names,
         ...
         */
        gmml::ResidueNameMap
        GetRecognizedResidueNamesMap(PdbFileSpace::PdbFile::PdbPairVectorAtomNamePositionFlag pdb_residue_names,
                                     gmml::ResidueNameMap dataset_residue_names);
        /*! \fn
        ...
        GetUnrecognizedResidues(PdbFileSpace::PdbFile::PdbResidueVector pdb_residues,
        ...
        //**************************************************
        PdbFileSpace::PdbFile::PdbResidueVector
        GetRecognizedResidues(PdbFileSpace::PdbFile::PdbResidueVector pdb_residues,
         ...
         */
        void RemoveUnrecognizedResiduesWithTheGivenModelNumber(
            PdbPreprocessorUnrecognizedResidueVector unrecognized_residues, int model_number = 1);
         ...
         * @param model_number Selected model number from the multiple models that are in a pdb file
         */
        void UpdateCYSResiduesWithTheGivenModelNumber(PdbPreprocessorDisulfideBondVector disulfide_bonds,
                                                      int model_number = 1);
        /*! \fn
         ...
         * @param model_number Selected model number from the multiple models that are in a pdb file
         */
        void UpdateHISMappingWithTheGivenNumber(PdbPreprocessorHistidineMappingVector histidine_mappings,
                                                int model_number = 1);
        ...
        GetUnknownHeavyAtomsOfResidue(PdbFileSpace::PdbFile::PdbAtomCardVector pdb_atoms,
         ...
         * @param model_number Selected model number from the multiple models that are in a pdb file
         */
        void RemoveResiduesOfUnknownHeavyAtomsWithTheGivenModelNumber(
            PdbPreprocessorUnrecognizedHeavyAtomVector unknown_heavy_atoms, int model_number = 1);
         ...
         */
        PdbFileSpace::PdbFile::PdbAtomCardVector
        GetRemovedHydrogensOfResidue(PdbFileSpace::PdbFile::PdbAtomCardVector pdb_atoms,
                                     std::vector<std::string> dataset_atom_names_of_residue);
         ...
         * @param model_number Selected model number from the multiple models that are in a pdb file
         */
        void RemoveRemovedHydrogensWithTheGivenModelNumber(PdbPreprocessorReplacedHydrogenVector replaced_hydrogens,
                                                           int model_number = 1);
        /*! \fn
         ...
         * @param model_number Selected model number from the multiple models that are in a pdb file
         */
        void UpdateAminoAcidChainsWithTheGivenModelNumber(PdbPreprocessorChainTerminationVector chain_terminations,
                                                          int model_number = 1);
         ...
         * @param model_number Selected model number from the multiple models that are in a pdb file
         */
        void UpdateGapsInAminoAcidChainsWithTheGivenModelNumber(PdbPreprocessorMissingResidueVector gaps,
                                                                int model_number = 1);
        /** @}*/
        /** \addtogroup Molecular_Data_Structure
         * @{
         ...
         * @param model_number Selected model number from the multiple models that are in a pdb file
         */
        void RemoveUnselectedAlternateResiduesWithTheGivenModelNumber(
            PdbPreprocessorAlternateResidueMap alternate_residue_map /*, int model_number = 1*/);
        /*! \fn
         ...
         */
        // void Preprocess(PdbFileSpace::PdbFile* pdb_file, std::vector<std::string> amino_lib_files_path,
      ...
      private:
        ...
        //                  PRIVATE ACCESSOR                    //
        //////////////////////////////////////////////////////////
        inline PdbFileSpace::PdbFile& GetPdbFile()
        {
            return pdbFile_;
        }
        ...
        inline parameters::Manager& GetParameters()
        {
        ...
        PdbPreprocessorHistidineMappingVector
            histidine_mappings_; /*!< List of histidine residues detected in a pdb file >*/
        PdbPreprocessorMissingResidueVector
            missing_residues_; /*!< List of gaps (missing residues) detected in a pdb file >*/
        PdbPreprocessorUnrecognizedResidueVector
            unrecognized_residues_; /*!< List of unrecognized residues detected in a pdb file >*/
        PdbPreprocessorUnrecognizedHeavyAtomVector
            unrecognized_heavy_atoms_; /*!< List of unrecognized heavy atoms detected in a pdb file >*/
        PdbPreprocessorReplacedHydrogenVector
            replaced_hydrogens_; /*!< List of removed/replaced hydrogen atoms detected in a pdb file >*/
        PdbPreprocessorAlternateResidueMap
            alternate_residue_map_; /*!< Map of alternate residues detected in a pdb file >*/
        PdbPreprocessorToBeDeletedAtomVector to_be_deleted_atoms_; /*!< List of atoms to be deleted in a pdb file >*/
        PdbPreprocessorToBeDeletedResidueVector
            to_be_deleted_residues_;                     /*!< List of residues to be deleted in a pdb file >*/
