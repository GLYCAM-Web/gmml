...
namespace PdbPreprocessorSpace
{
    class PdbPreprocessorDisulfideBond
    {
      public:
         ...
         * @param sulfur_atom_serial_number_1 Sulfur atom serial number of the first CYS residue involved in the
         * disulfide bond
         * @param sulfur_atom_serial_number_2 Sulfur atom serial number of the second CYS residue involved in the
         * disulfide bond
         */
        PdbPreprocessorDisulfideBond(char chain_id_1, char chain_id_2, int residue_sequence_number_1,
      ...
      private:
        ...
        int residue_sequence_number_2_; /*!< Sequence number of the second CYS residue involved in the disulfide bond
                                           >*/
        double distance_; /*!< The distance between the two sulfor atoms in each CYS residue that are involved in the
                             disulfide bond >*/
        ...
        char residue_alternate_location_1_; /*!< Alternate location of the first CYS residue involved in the disulfide
                                               bond >*/
        char residue_alternate_location_2_; /*!< Alternate location of the second CYS residue involved in the disulfide
                                               bond >*/
        int sulfur_atom_serial_number_1_;   /*!< Sulfur atom serial number of the first CYS residue involved in the
                                               disulfide bond >*/
        int sulfur_atom_serial_number_2_;   /*!< Sulfur atom serial number of the second CYS residue involved in the
                                               disulfide bond >*/
    };
} // namespace PdbPreprocessorSpace
