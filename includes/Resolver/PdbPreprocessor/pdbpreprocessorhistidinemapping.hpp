...
namespace PdbPreprocessorSpace
{
    class PdbPreprocessorHistidineMapping
    {
      public:
         ...
         * @param selected_mapping Selected type of the histidine residue from the all possible types that have been
         * defined in PdbPreprocessorHISMapping enumerator
         ...
         */
        PdbPreprocessorHistidineMapping(char chain_id, int residue_sequence_number,
                                        gmml::PdbPreprocessorHISMapping selected_mapping, char residue_insertion_code,
