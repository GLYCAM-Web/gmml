...
namespace PdbPreprocessorSpace
{
    class PdbPreprocessorMissingResidue
    {
      public:
         ...
         */
        PdbPreprocessorMissingResidue(char chain_id, int start_index, int end_index, int index_before_gap,
        ...
        /*! \fn
         * Convert a selected value of PossibleNChainTermination enumerator (selected_n_termination_) to the string
         * version of it
         */
        std::string GetStringFormatOfSelectedNTermination();

        /*! \fn
         * Convert a selected value of PossibleCChainTermination enumerator (selected_c_termination_) to the string
         * version of it
         */
      ...
      private:
        ...
        gmml::PossibleNChainTermination selected_n_termination_; /*!< Selected n terminal residue from the possible n
                                                                    terminals for the detected gap >*/
        gmml::PossibleCChainTermination selected_c_termination_; /*!< Selected c terminal residue from the possible c
                                                                    terminals for the detected gap >*/
