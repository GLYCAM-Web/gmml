...
namespace PdbPreprocessorSpace
{
    ...
    class PdbPreprocessorChainTermination
    {
      ...
      private:
        ...
        gmml::PossibleNChainTermination
            selected_n_termination_; /*!< Selected n terminal residue from the all possible n terminals >*/
        gmml::PossibleCChainTermination
            selected_c_termination_;           /*!< Selected c terminal residue from the all possible c terminals >*/
