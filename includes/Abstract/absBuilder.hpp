...
// Update: the status idea is bad, classes that aren't ok should throw. Stop-gap for now, as I can't yet throw across
// SWIG and into gems.
#include <string>
...
namespace Abstract
{
    class absBuilder
    {
      public:
        ...
        {
            return this->GetStatusType() == "OK";
        }

        inline std::string GetStatusType()
        {
            return statusType_;
        }

        inline std::string GetStatusMessage()
        {
        ...
        //                       MUTATOR                        //
        //////////////////////////////////////////////////////////
        inline void SetStatusType(std::string s)
        {
            statusType_ = s;
        }

        inline void SetStatusMessage(std::string s)
        {
            statusMessage_ = s;
        }

        inline void SetStatus(std::string type, std::string message)
        {
